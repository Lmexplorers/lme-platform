...
(function () {
  ...
  var DICT = {
    ...
    ai_note: ['AI-tekst lages av Nathalie AI. En hel bok tar vanligvis 30 til 90 sekunder. Uten API-nøkkel brukes innebygde maler, så alt fungerer uansett.', 'AI text is written by Nathalie AI. A full book usually takes 30 to 90 seconds. Without an API key the built-in templates are used, so everything works either way.'],
