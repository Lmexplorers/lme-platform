...
''' + card('<p class="center">Samme bøttehatt som NORGE- og RO-oppskriftene for voksne, gradert helt fra bunnen av til '
      'tjueen babyer-, barne- og ungdomsstørrelser, 50 til 170. Egne, mindre bokstaver og et eget lite flaggmotiv er laget '
...
# ============ SIDE 11: TABELL OPPSETT FØR TOPP ============
pages.append(make_page('LME STRIKKEOPPSKRIFT&nbsp;&nbsp;|&nbsp;&nbsp;BØTTEHATTER BARN')(
...
''' + card('<p class="center">The same bucket hat as the NORGE and RO patterns for adults, graded completely '
      'from scratch into twenty-one baby, child and teen sizes, 50 to 170. Smaller letters and a small flag motif were '
...
# ============ PAGE 11: TABLE SETUP BEFORE THE CROWN ============
pages.append(page(
