...
PHOTO = BASE / 'norge_innstrikket_ref.jpg'
...
<div class="subpill">MØNSTERET STRIKKET INN, MED BØLGET BREM</div>
{card('<p class="center">En sommerhatt i rød bomull med "Norge" og flagget foran, og "Ro" med to bølgeskvulp bak. '
      'Her er bokstavene, flagget og bølgene strikket rett inn i hatten med flerfargestrikk, ikke brodert på. '
...
strikker du inn "Norge", flagget, "Ro" og bølgene med flerfargestrikk, altså rett inn i hatten
...
{steps([
  ...
  'Nå kommer <b>mønsterbåndet</b>. Følg diagrammene: "Norge" og flagget foran (side 9), "Ro" og '
  'bølgene bak (side 10). Foran og bak strikkes på de samme omgangene, med rødt imellom og på sidene.',
  'Alle motivene starter på <b>samme omgang</b>, den første i mønsterbåndet. Flagget er høyest med '
  '10 omganger. Over de lavere motivene (bokstaver og bølger) strikker du bare rødt til båndet er ferdig.',
  'Når hele mønsterbåndet er strikket (10 omganger), klipp av hvit og blå og la ca. 5 cm henge '
...
<title>Norge-bøttehatt (strikket inn), LME strikkeoppskrift</title>
<style>{css}</style></head>
<body>{''.join(pages)}</body></html>'''

(BASE / 'hatt_knit.html').write_text(doc, encoding='utf-8')
