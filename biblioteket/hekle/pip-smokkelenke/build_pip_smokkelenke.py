...
add('cover_desc',
    'En liten smokkelenke med et forenklet pinnsvinhode inspirert av Pip, med en liten '
    'løkkemasket "piggstripe" i stedet for sløyfe, og noen myke heklede kuler. Heklet i de '
    ...
    "A little pacifier clip with a simplified hedgehog head inspired by Pip, with a little "
    "loop-stitch \"spike stripe\" instead of a bow, and a few soft crocheted balls. Crocheted "
    "in the same natural colours as the rest of the collection. Maximum length follows current "
...
add('oversikt_deler', [
    ...
    ('2. Piggstripen', 'liten løkkemasket stripe i stedet for sløyfe', '2. The spike stripe',
...
# ---------------------------------------------------------------- SIDE 8: PIGGSTRIPEN
add('banner_pigg', 'DEL 2: PIGGSTRIPEN', 'PART 2: THE SPIKE STRIPE')
...
add('kuler_lead',
    ...
    'gjerne i en rytme av kremhvitt og mørkt brunt. Husk: total lengde skal aldri bli mer enn '
    '22 cm.',
    'Crochet as many balls as you need to fill out the length between the clip and the '
    'hedgehog head, for example alternating cream and dark brown. Remember: the total length '
    'must never exceed 22 cm.')
add('kuler_rows', [
    ('1', '6 fm i magisk ring', 6),
    ('2', 'økn x 6', 12),
...
add('montering_steg', [
    ...
    'Sy piggstripen fast langs midtlinjen på pinnsvinhodet.',
...
add('montering_steg_en', [
    ...
    'Sew the spike stripe on along the centre line of the hedgehog head.',
...
add('foto_captions',
    ['Pinnsvinhodet ferdig', 'Piggstripen', 'Kulene på rekke', 'Ferdig montert lenke'],
    ['The finished hedgehog head', 'The spike stripe', 'The balls in a row',
...
add('kolleksjon_liste',
    ['Ellie, det lille dådyret', 'Pip, det lille pinnsvinet', 'Felix, den lille reven',
     ...
     'Ellies smokkelenke', 'Ellies rangle', 'Ellies vognlenke', 'Ellies ballerinasko',
    ...
    ['Ellie, the little fawn', 'Pip, the little hedgehog', 'Felix, the little fox',
     ...
     "Ellie's pacifier clip", "Ellie's rattle", "Ellie's stroller toy",
