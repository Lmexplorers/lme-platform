...
alle_sider_src = img_src('luna_alle_sider.jpg')
speil_src = img_src('luna_speil.jpg')
form_src = img_src('luna_form.jpg')
lomme_src = img_src('luna_lomme.jpg')
knitre_src = img_src('luna_knitre.jpg')
...
add('caption_lomme', 'Lomme-siden med miniatyr-Luna, stiluttrykk-referanse.',
    'The pocket side with miniature Luna, style reference.')
...
<div class="figwrap"><img src="{alle_sider_src}" alt="Lunas aktivitetsleke, alle sidene" style="width:100mm"><div class="figcap">{t('caption_alle_sider')}</div></div>
''', 6))
