# -*- coding: utf-8 -*-
"""Genererer LME-hekleoppskrift 'Ellies vognlenke' (norsk + engelsk) som HTML,
...
# ---------------------------------------------------------------- SIDE 1
add('doctitle', 'Ellies vognlenke, LME hekleoppskrift', "Ellie's Stroller Toy, LME crochet pattern")
add('ph2', 'LME HEKLEOPPSKRIFT&nbsp;&nbsp;|&nbsp;&nbsp;ELLIES VOGNLENKE',
    "LME CROCHET PATTERN&nbsp;&nbsp;|&nbsp;&nbsp;ELLIE'S STROLLER TOY")
add('covertag', 'LME HEKLEOPPSKRIFT - BABY', 'LME CROCHET PATTERN - BABY')
add('covertitle', 'ELLIES VOGNLENKE', "ELLIE'S STROLLER TOY")
add('subpill', 'LME BABY COLLECTION - WOODLAND DREAMS', 'LME BABY COLLECTION - WOODLAND DREAMS')
add('cover_desc',
    'En liten vognlenke med Ellie midt på i en pudderrosa volangkrage, dinglende fra en kjede '
    ...
    "A little stroller toy with Ellie in the middle in a powder pink ruffled collar, hanging "
...
# ---------------------------------------------------------------- SIDE 2
add('banner_om', 'OM ELLIES VOGNLENKE', "ABOUT ELLIE'S STROLLER TOY")
add('pill_historien', 'DEL AV ELLIES VERDEN', "PART OF ELLIE'S WORLD")
add('om_historien',
    'Ellies vognlenke hører til LME Baby Collection "Woodland Dreams". Ellie henger midt på '
    ...
    'Ellie\'s stroller toy belongs to the LME Baby Collection "Woodland Dreams". Ellie hangs in '
...
add('om_stil',
    ...
    'En myk kjede av runde kuler og treperler, med Ellie som det tydelige midtpunktet.',
    'Scandinavian and Montessori-inspired, in the same natural colours as the rest of the '
    'collection. A soft chain of round balls and wooden beads, with Ellie as the clear centre '
    'point.')
...
add('garn_txt',
    'Bystrikk Merino (brunt og kremhvitt) og rester av pudderrosa og salviegrønt, samme '
    'garnfamilie som resten av Ellie-kolleksjonen.',
    'Bystrikk Merino (brown and cream) and leftover powder pink and sage green, the same yarn '
...
add('utstyr', [
    ...
    ('Litt polyesterfiber til fyll', 'kun til Ellie-medaljongen og kulene'),
...
add('oversikt_lead',
    ...
    'beads, with Ellie in the middle:')
add('oversikt_deler', [
    ('1. Ellie-medaljongen', 'midtdelen, med volangkrage', '1. The Ellie medallion',
     'the centre piece, with a ruffled collar'),
...
add('banner_medaljong', 'DEL 1: ELLIE-MEDALJONGEN', 'PART 1: THE ELLIE MEDALLION')
add('medaljong_lead',
    'Midtdelen er en liten, flat utgave av Ellies hode, lett stoppet slik at den får litt form '
    'uten å bli tung.',
    "The centre piece is a small, flat version of Ellie's head, lightly stuffed so it gets a "
    "little shape without becoming heavy.")
add('medaljong_rows', [
...
add('rangler_lead',
    ...
    'side av Ellie-medaljongen. Disse er det barnet griper etter og rasler med.',
    'Two wooden rings with a small dangling crocheted ball inside each, attached partway along '
    'the chain on each side of the Ellie medallion. These are what the child reaches for and '
    'rattles.')
add('rangler_txt',
...
add('rangler_ferdig',
    ...
    'selve ringen godt fast tett inntil hovedkjeden på hver side av Ellie, med flere runder '
    ...
    'looser. Sew the ring itself securely close against the main chain on each side of Ellie, '
...
add('kuler_lead',
    ...
    'brunt, kremhvitt og pudderrosa, med en liten tre-mellomperle mellom hver kule, som i '
    ...
    'alternating brown, cream and powder pink, with a small wooden spacer bead between each '
    'ball, as in the reference photo. Remember: the total length must never exceed 35 to 40 cm.')
add('kuler_rows', [
...
add('montering_lead',
    'Legg Ellie-medaljongen, blomsten, bladet, de to trering-ranglene og alle kulene ut i den '
    'rekkefølgen du vil ha dem, før du fester noe permanent.',
    'Lay out the Ellie medallion, the flower, the leaf, the two wooden ring rattles and all the '
...
add('ferdig_txt',
    'Nå har du heklet en liten vognlenke til Ellie-kolleksjonen. Husk å sjekke lengden en '
    'siste gang før den festes til vognen!',
    "Now you have crocheted a little stroller toy for the Ellie collection. Remember to check "
    "the length one last time before attaching it to the pram!")
add('pill_kolleksjon', 'RESTEN AV LME BABY COLLECTION', 'THE REST OF THE LME BABY COLLECTION')
add('kolleksjon_liste',
    ['Ellie, det lille dådyret', 'Ellies smokkelenke', 'Ellies rangle', 'Ellies aktivitetsleke',
     'Ellies ballerinasko med sløyfe'],
    ['Ellie, the little fawn', "Ellie's pacifier clip", "Ellie's rattle",
     "Ellie's activity toy", "Ellie's ballerina shoes with a bow"])
