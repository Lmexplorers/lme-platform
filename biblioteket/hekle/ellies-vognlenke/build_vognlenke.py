...
add('garn_txt',
    'Bystrikk Merino (brunt og kremhvitt) og rester av pudderrosa og salviegrønt, pluss litt '
    'gult til solen, samme garnfamilie som resten av Ellie-kolleksjonen.',
    'Bystrikk Merino (brown and cream) and leftover powder pink and sage green, plus a little '
    'yellow for the sun, the same yarn family as the rest of the Ellie collection.')
add('garn_alt',
...
add('utstyr', [
    ...
    ('Litt polyesterfiber til fyll', 'kun til Ellie-medaljongen'),
...
add('ord_lead',
    'Motivene bruker fastmasker, stav og halvstav, akkurat som Ellies smokkelenke.',
    "The motifs use single, double and half double crochet, just like Ellie's pacifier clip.")
...
add('medaljong_lead',
    'Midtmotivet er en liten, flat utgave av Ellies hode, lett stoppet slik at den får litt '
    'form uten å bli tung.',
    "The centre motif is a small, flat version of Ellie's head, lightly stuffed so it gets a "
...
add('sommerfugl_txt',
    ...
    'stk). Hekle en liten kropp i brunt: 5 lm, kjm i hver lm tilbake. Legg kroppen mellom de to '
    'vingene og sy alt sammen på midten. Brodér to korte antenner i svart tråd øverst på '
    'kroppen.',
    'Crochet two matching wings in powder pink: 6 sc in a magic ring, inc x 6 (12), fasten off '
    '(make 2). Crochet a small body in brown: 5 ch, sl st in each ch back across. Place the '
...
add('foto_captions',
    ['Alle sju motivene', 'Ellie midt på snoren', 'Motivene fordelt', 'Ferdig montert lenke'],
    ['All seven motifs', 'Ellie in the middle of the cord', 'The motifs spread out',
...
def build(lang):
    ...
    pages.append(pg(f'''
<div class="coverimg"><img src="{ref_src}" alt="Ellie, referanse for vognlenkens uttrykk"></div>
<p class="small center" style="margin-top:-2mm;">{'Bildet viser Ellie, det lille dådyret, som stiluttrykk-referanse, ikke selve vognlenken.' if lang == 'no' else 'Photo shows Ellie, the little fawn, as a style reference, not the stroller toy itself.'}</p>
