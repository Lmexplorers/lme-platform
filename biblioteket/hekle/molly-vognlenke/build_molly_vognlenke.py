...
add('cover_desc',
    'En liten vognlenke med Molly midt på i en smørgul volangkrage, dinglende fra en kjede av '
    ...
    "A little stroller toy with Molly in the middle in a butter yellow ruffled collar, hanging "
...
add('om_stil',
    ...
    'En myk kjede av runde kuler og treperler, med Molly som det tydelige midtpunktet.',
    'Scandinavian and Montessori-inspired, in the same natural colours as the rest of the '
    'collection. A soft chain of round balls and wooden beads, with Molly as the clear centre '
    'point.')
...
add('garn_txt',
    'Bystrikk Merino (kremhvitt og smørgult) og rester av pudderrosa og salviegrønt, samme '
    "garnfamilie som resten av Mollys oppskrift.",
    "Bystrikk Merino (cream and butter yellow) and leftover powder pink and sage green, the "
    "same yarn family as the rest of Molly's pattern.")
add('garn_alt',
...
add('utstyr', [
    ...
    ('Litt polyesterfiber til fyll', 'kun til Molly-medaljongen og kulene'),
...
add('ord_lead',
    'Delene bruker fastmasker, stav og halvstav, i tillegg til løkkemasker på ulltoppen, '
    'akkurat som Mollys smokkelenke.',
    "The pieces use single, double and half double crochet, plus loop stitches on the wool "
...
add('oversikt_lead',
    ...
    'beads, with Molly in the middle:')
add('oversikt_deler', [
    ('1. Molly-medaljongen', 'midtdelen, med volangkrage, ulltopp og sløyfe', '1. The Molly '
     'medallion', 'the centre piece, with a ruffled collar, wool topknot and bow'),
...
add('medaljong_lead',
    'Midtdelen er en liten, flat utgave av Mollys hode, kremhvit, lett stoppet slik at den får '
    'litt form uten å bli tung.',
    "The centre piece is a small, flat version of Molly's head, cream, lightly stuffed so it "
...
add('medaljong_ferdig',
    ...
    'avslutt, hekle 2 stk) øverst, hekle en liten tett ulltopp (6 til 8 løkkemasker rett inn på '
    'overflaten mellom ørene) og en mini sløyfe i smørgult (legg opp 8 lm + 1 vendemaske, 1 rad '
    'fm, fold og sy fast oppå ulltoppen), og brodér et lite ansikt akkurat som på rangelen og '
    'smokkelenken.',
...
add('rangler_lead',
    ...
    'side av Molly-medaljongen. Disse er det barnet griper etter og rasler med.',
    'Two wooden rings with a small dangling crocheted ball inside each, attached partway along '
    'the chain on each side of the Molly medallion. These are what the child reaches for and '
    'rattles.')
add('rangler_txt',
...
add('rangler_ferdig',
    ...
    'selve ringen godt fast tett inntil hovedkjeden på hver side av Molly, med flere runder '
    ...
    'looser. Sew the ring itself securely close against the main chain on each side of Molly, '
...
add('kuler_lead',
    ...
    'kremhvitt, smørgult og pudderrosa, med en liten tre-mellomperle mellom hver kule, som i '
    'referansebildet. Husk: total lengde skal aldri bli mer enn 35 til 40 cm.',
    'Crochet as many balls as you need to fill out the rest of the chain, for example '
    'alternating cream, butter yellow and powder pink, with a small wooden spacer bead between '
...
add('montering_lead',
    'Legg Molly-medaljongen, blomsten, bladet, de to trering-ranglene og alle kulene ut i den '
    'rekkefølgen du vil ha dem, før du fester noe permanent.',
    'Lay out the Molly medallion, the flower, the leaf, the two wooden ring rattles and all the '
...
add('montering_steg', [
    ...
    'Sy Molly-medaljongen fast midt på kjeden, med volangkragen, ulltoppen og sløyfen ferdig '
    'heklet.',
...
add('montering_steg_en', [
    ...
    'Sew the Molly medallion onto the middle of the chain, with the ruffled collar, wool '
    'topknot and bow already crocheted on.',
    'Thread the balls onto the cord with a small wooden spacer bead between each one, evenly '
    'distributed on both sides of Molly.',
...
<p class="small center" style="margin-top:-2mm;">{'Bildet viser Mollys ansikt som stiluttrykk-referanse, ikke selve vognlenken.' if lang == 'no' else "Photo shows Molly's face as a style reference, not the stroller toy itself."}</p>
