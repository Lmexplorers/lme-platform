...
REF = BASE.parent / 'oliver-smokkelenke' / 'oliver_face_ref.jpg'
...
<p class="small center" style="margin-top:-2mm;">{'Bildet viser Olivers ansikt som stiluttrykk-referanse, ikke selve vognlenken.' if lang == 'no' else "Photo shows Oliver's face as a style reference, not the stroller toy itself."}</p>
