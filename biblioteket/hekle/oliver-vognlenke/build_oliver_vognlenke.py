# -*- coding: utf-8 -*-
"""Genererer LME-hekleoppskrift 'Olivers vognlenke' (norsk + engelsk) som HTML,
...
# ---------------------------------------------------------------- SIDE 1
add('doctitle', 'Olivers vognlenke, LME hekleoppskrift', "Oliver's Stroller Toy, LME crochet pattern")
add('ph2', 'LME HEKLEOPPSKRIFT&nbsp;&nbsp;|&nbsp;&nbsp;OLIVERS VOGNLENKE',
    "LME CROCHET PATTERN&nbsp;&nbsp;|&nbsp;&nbsp;OLIVER'S STROLLER TOY")
add('covertag', 'LME HEKLEOPPSKRIFT - BABY', 'LME CROCHET PATTERN - BABY')
add('covertitle', 'OLIVERS VOGNLENKE', "OLIVER'S STROLLER TOY")
add('subpill', 'LME BABY COLLECTION - WOODLAND DREAMS', 'LME BABY COLLECTION - WOODLAND DREAMS')
add('cover_desc',
    'En liten vognlenke med Oliver midt på, omgitt av sky, sol, blad, blomst, stjerne og '
    'sommerfugl, pluss to sideringer i tre med en liten heklet kule dinglende inni hver. Festes '
    'med to klips eller ringer over barnevognens bøyle. Heklet i de samme rolige fargene som '
    'resten av kolleksjonen, med lengde satt bevisst kort av sikkerhetshensyn.',
    "A little stroller toy with Oliver in the middle, surrounded by a cloud, sun, leaf, "
    "flower, star and butterfly, plus two wooden side rings with a small crocheted ball "
    "dangling inside each one. Attached with two clips or rings across the stroller's bar. "
    "Crocheted in the same calm colours as the rest of the collection, with a length kept "
...
# ---------------------------------------------------------------- SIDE 2
add('banner_om', 'OM OLIVERS VOGNLENKE', "ABOUT OLIVER'S STROLLER TOY")
add('pill_historien', 'DEL AV ELLIES VERDEN', "PART OF ELLIE'S WORLD")
add('om_historien',
    "Olivers vognlenke hører til LME Baby Collection \"Woodland Dreams\". Oliver henger midt "
    'på lenken, omgitt av tingene han elsker fra skogbunnen og himmelen over skogen: sol, sky, '
    'stjerner, blomster, blader og en liten sommerfugl.',
    "Oliver's stroller toy belongs to the LME Baby Collection \"Woodland Dreams\". Oliver "
    "hangs in the middle of the toy, surrounded by the things he loves from the forest floor "
    "and the sky above the forest: sun, cloud, stars, flowers, leaves and a little butterfly.")
add('pill_stil', 'STIL', 'STYLE')
add('om_stil',
    'Skandinavisk og Montessori-inspirert, i de samme rolige fargene som resten av '
    'kolleksjonen. Enkle, flate motiver som er lette å kjenne igjen for et lite barn som '
    'ligger og ser opp.',
...
add('garn_txt',
    'Bystrikk Merino (varmt lyst brunt og lyseblått) og rester av pudderrosa og salviegrønt, '
    "pluss litt gult til solen, samme garnfamilie som resten av Olivers oppskrift.",
    "Bystrikk Merino (warm light brown and light blue) and leftover powder pink and sage "
    "green, plus a little yellow for the sun, the same yarn family as the rest of Oliver's "
    "pattern.")
add('garn_alt',
...
add('utstyr', [
    ...
    ('Litt polyesterfiber til fyll', 'kun til Oliver-medaljongen'),
...
add('ord_lead',
    "Motivene bruker fastmasker, stav og halvstav, akkurat som Olivers smokkelenke.",
    "The motifs use single, double and half double crochet, just like Oliver's pacifier "
    "clip.")
...
add('oversikt_lead',
    'Syv motiver hekles hver for seg og festes tett langs en kort hovedstreng, med Oliver i '
    'midten, pluss to sideringer med kuler:',
    'Seven motifs are crocheted separately and attached close together along a short main '
    'strand, with Oliver in the middle, plus two side rings with balls:')
add('oversikt_deler', [
    ('1. Oliver-medaljongen', 'midtmotivet, med runde bamseører', '1. The Oliver medallion',
     'the centre motif, with round teddy bear ears'),
    ...
    ('7. Sommerfuglen', 'pudderrosa og lyseblått', '7. The butterfly', 'powder pink and '
     'light blue'),
    ('8. Sideringene', 'to treringer med en dinglende kule i hver', '8. The side rings',
     'two wooden rings with a dangling ball in each'),
])

# ---------------------------------------------------------------- SIDE 7: OLIVER-MEDALJONGEN
add('banner_medaljong', 'DEL 1: OLIVER-MEDALJONGEN', 'PART 1: THE OLIVER MEDALLION')
add('medaljong_lead',
    "Midtmotivet er en liten, flat utgave av Olivers hode, varmt lyst brunt, lett stoppet "
    'slik at den får litt form uten å bli tung.',
    "The centre motif is a small, flat version of Oliver's head, warm light brown, lightly "
    "stuffed so it gets a little shape without becoming heavy.")
add('medaljong_rows', [
...
add('medaljong_ferdig',
    'Klipp av med god tråd igjen. Sy to små runde ører (6 fm i magisk ring, økn x 6 (12), '
    'avslutt, hekle 2 stk) øverst, den klassiske bamseformen i miniatyr, ingen sløyfe, ingen '
    'ekstra pynt. Brodér til slutt et lite ansikt akkurat som på rangelen og smokkelenken.',
    'Cut, leaving a long tail. Sew on two small round ears (6 sc in a magic ring, inc x 6 '
    '(12), fasten off, make 2) on top, the classic teddy bear shape in miniature, no bow, no '
    'extra decoration. Finally, embroider a small face just like on the rattle and pacifier '
    "clip.")
...
add('sommerfugl_txt',
    ...
    'stk). Hekle en liten kropp i lyseblått: 5 lm, kjm i hver lm tilbake. Legg kroppen mellom '
    ...
    '(make 2). Crochet a small body in light blue: 5 ch, sl st in each ch back across. Place '
    'the body between the two wings and sew everything together in the middle. Embroider two '
...
add('sideringer_lead',
    ...
    'side av Oliver-medaljongen.',
    "Two small wooden rings with a dangling crocheted ball inside each, attached partway "
    "along the strand on each side of the Oliver medallion.")
add('sideringer_txt',
    "Kulene: hekle to kuler, samme oppskrift som på Olivers smokkelenke: 6 fm i magisk ring, "
    'økn x 6 (12), 12 fm i 2 omganger, mink x 6 (6), fyll lett, fest av med god tråd igjen.',
    "The balls: crochet two balls, the same pattern as on Oliver's pacifier clip: 6 sc in a "
...
add('sideringer_ferdig',
    ...
    'selve ringen godt fast tett inntil hovedstrengen på hver side av Oliver, med flere '
    'runder overstingsøm, ikke bare tredd løst gjennom snoren.',
    ...
    'Oliver, with several rounds of whip stitching, not just threaded loosely onto the cord.')
...
add('montering_lead',
    ...
    'Oliver i midten, før du fester noe permanent.',
    'Lay out all seven motifs and the two side rings in the order you want, with Oliver in '
...
add('montering_steg', [
    ...
    'Sy Oliver-medaljongen fast midt på snoren.',
    'Fordel de seks andre motivene jevnt på hver side av Oliver, tett inntil hovedstrengen, '
    'og sy dem godt fast.',
...
add('montering_steg_en', [
    ...
    'Sew the Oliver medallion onto the middle of the cord.',
    'Distribute the other six motifs evenly on each side of Oliver, close against the main '
    'strand, and sew them on securely.',
    'Attach the two side rings with the balls a little further out on each side, securely '
    'with whip stitching.',
...
add('foto_captions',
    ['Alle sju motivene', 'Oliver midt på snoren', 'Motivene fordelt', 'Ferdig montert lenke'],
    ['All seven motifs', 'Oliver in the middle of the cord', 'The motifs spread out',
...
add('ferdig_txt',
    'Nå har du heklet en liten Oliver-vognlenke. Husk å sjekke lengden en siste gang før den '
    'festes til vognen!',
    "Now you have crocheted a little Oliver stroller toy. Remember to check the length one "
...
add('kolleksjon_liste',
    ['Ellie, det lille dådyret', 'Pip, det lille pinnsvinet', 'Felix, den lille reven',
     ...
     "Felix' vognlenke", 'Mollys vognlenke', 'Lunas vognlenke', 'Ellies vognlenke',
    ...
    ['Ellie, the little fawn', 'Pip, the little hedgehog', 'Felix, the little fox',
     ...
     "Luna's stroller toy", "Ellie's stroller toy", "Ellie's ballerina shoes",
...
<p class="small center" style="margin-top:-2mm;">{'Bildet viser Oliver som stiluttrykk-referanse, ikke selve vognlenken.' if lang == 'no' else 'Photo shows Oliver as a style reference, not the stroller toy itself.'}</p>
