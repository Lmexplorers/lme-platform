...
add('cover_desc',
    ...
    'lyseblå minikrage i stedet for sløyfe, og noen myke heklede kuler. Heklet i de samme '
    ...
    "light blue mini collar instead of a bow, and a few soft crocheted balls. Crocheted in "
...
add('kuler_lead',
    ...
    'gjerne i en rytme av varmt lyst brunt og lyseblått. Husk: total lengde skal aldri bli '
    'mer enn 22 cm.',
    'Crochet as many balls as you need to fill out the length between the clip and the bear '
    'head, for example alternating warm light brown and light blue. Remember: the total '
