# -*- coding: utf-8 -*-
"""Genererer LME-hekleoppskrift 'Olivers aktivitetsleke' (norsk + engelsk) som HTML,
...
REF = BASE / 'oliver_aktivitetsleke_real.jpg'
...
alle_sider_src = img_src('oliver_alle_sider.jpg')
speil_src = img_src('oliver_speil.jpg')
form_src = img_src('oliver_form.jpg')
lomme_src = img_src('oliver_lomme.jpg')
knitre_src = img_src('oliver_knitre.jpg')
...
add('caption_lomme', 'Lomme-siden med miniatyr-Oliver, stiluttrykk-referanse.',
    'The pocket side with miniature Oliver, style reference.')
...
# ---------------------------------------------------------------- SIDE 1
add('doctitle', 'Olivers aktivitetsleke, LME hekleoppskrift', "Oliver's Activity Toy, LME crochet pattern")
add('ph2', 'LME HEKLEOPPSKRIFT&nbsp;&nbsp;|&nbsp;&nbsp;OLIVERS AKTIVITETSLEKE',
    "LME CROCHET PATTERN&nbsp;&nbsp;|&nbsp;&nbsp;OLIVER'S ACTIVITY TOY")
add('covertag', 'LME HEKLEOPPSKRIFT - BABY', 'LME CROCHET PATTERN - BABY')
add('covertitle', 'OLIVERS AKTIVITETSLEKE', "OLIVER'S ACTIVITY TOY")
...
add('cover_desc',
    ...
    'seks sidene: Oliver med sin lyseblå volangkrage (ingen sløyfe), et babysikkert speil i en '
    'lyseblå blomsterramme, en formside med hjerte, stjerne, blad og sky, Oliver som titter opp '
    'av en lyseblå lomme, og en knitreside med en liten stjernehimmel-sky som knitrer når man '
    'klemmer den. To hjørneringer i tre og en perlekant på toppen fullfører kuben.',
    'A soft activity cube, approx. 11 to 12 cm per side, full of things to explore on each of '
    'the six sides: Oliver with his light blue ruffled collar (no bow), a baby-safe mirror in a '
    'light blue flower frame, a shapes side with a heart, a star, a leaf and a cloud, Oliver '
    'peeking out of a light blue pocket, and a crinkle side with a little starry-sky cloud that '
    'crinkles when you squeeze it. Two wooden corner rings and a bead trim along the top '
    'complete the cube.')
...
# ---------------------------------------------------------------- SIDE 2
add('banner_om', 'OM OLIVERS AKTIVITETSLEKE', "ABOUT OLIVER'S ACTIVITY TOY")
add('pill_historien', 'DEL AV OLIVERS VERDEN', "PART OF OLIVER'S WORLD")
add('om_historien',
    'Olivers aktivitetsleke hører til LME Baby Collection "Woodland Dreams". Kuben samler hele '
    'Olivers rolige verden på seks små sider: Oliver selv med sin lyseblå krage, speilet der '
    'barnet møter sitt eget speilbilde, formene fra skogens ting, lommen der Oliver titter '
    'frem, og den lille stjernehimmel-skyen som knitrer på knitresiden.',
    'Oliver\'s activity toy belongs to the LME Baby Collection "Woodland Dreams". The cube '
    'gathers Oliver\'s whole calm world across six small sides: Oliver himself with his light '
    'blue collar, the mirror where the child meets their own reflection, shapes from the '
    'forest, the pocket where Oliver peeks out, and the little starry-sky cloud that crinkles '
    'on the crinkle side.')
add('pill_stil', 'STIL OG SANSER', 'STYLE AND SENSES')
add('om_stil',
    'Skandinavisk og Montessori-inspirert, i de samme rolige fargene som resten av Olivers egen '
    'kolleksjon: varmt lyst brunt, kremhvitt og lyseblått. Hver side har sin egen oppgave å '
    'utforske, fra å kjenne igjen former til å høre en liten sky knitre, akkurat den typen '
    'sanselige, hands-on lek Montessori-filosofien bygger på.',
    "Scandinavian and Montessori-inspired, in the same calm colours as the rest of Oliver's own "
    "collection: warm light brown, cream and light blue. Each side has its own task to "
    "explore, from recognising shapes to hearing a little cloud crinkle, exactly the kind of "
    "sensory, hands-on play the Montessori philosophy is built on.")
add('pill_sikkerhet_kort', 'VIKTIGST AV ALT: SIKKERHET', 'MOST IMPORTANT OF ALL: SAFETY')
add('om_sikkerhet_kort',
    'Denne leken har flere små deler enn noen annen oppskrift i Oliver-kolleksjonen, og '
    ...
    "This toy has more small parts than any other pattern in Oliver's collection, and also "
...
add('garn_txt',
    'Bystrikk Merino i kremhvitt (kubens sider) og varmt lyst brunt (kantfarge og Olivers '
    'hode), pluss rester av pudderrosa, salviegrønt og lyseblått (kragen, lommen, '
    'speilrammen og en god del av knitresiden), samme garnfamilie som resten av '
    'Oliver-kolleksjonen.',
    "Bystrikk Merino in cream (the cube sides) and warm light brown (the edging colour and "
    "Oliver's head), plus leftover powder pink, sage green and light blue (the collar, the "
    "pocket, the mirror frame and a good part of the crinkle side), the same yarn family as "
    "the rest of the Oliver collection.")
add('garn_alt',
...
add('utstyr', [
    ...
    ('Polyesterfiber til fyll', 'til hjørner/kanter og til Oliver-motivene'),
...
add('vanskelig_txt',
    ...
    'du har heklet minst én av de andre Oliver-oppskriftene først.',
    ...
    "A good pattern once you have crocheted at least one of the other Oliver patterns first.")
...
add('oversikt_deler', [
    ...
    ('2. Oliver-siden', 'forsiden, med lyseblå volangkrage, ingen sløyfe', '2. The Oliver side',
     'the front, with a light blue ruffled collar, no bow'),
    ('3. Speil-siden', 'babysikkert speil i lyseblå blomsterramme', '3. The mirror side',
     'baby-safe mirror in a light blue flower frame'),
    ('4. Form-siden', 'hjerte, stjerne, blad og sky', '4. The shapes side',
     'heart, star, leaf and cloud'),
    ('5. Lomme-siden', 'miniatyr-Oliver titter opp av en lyseblå lomme', '5. The pocket side',
     'a miniature Oliver peeking out of a light blue pocket'),
    ('6. Knitre-siden', 'en liten stjernehimmel-sky med knitrende stoff inni, som knitrer når '
     'man klemmer', '6. The crinkle side', 'a little starry-sky cloud with crinkling material '
     'inside, that crinkles when squeezed'),
...
add('kvadrat_kant',
    'Rund av hvert kvadrat med én omgang fm i varmt lyst brunt rundt hele kanten (fm jevnt '
    'langs sidene, 3 fm i hvert hjørne for at det skal ligge flatt). Fest av og gjem tråden. '
    'Dette gir den lyse kantstripen du ser rundt hver side i referansebildet.',
    'Edge each square with one round of sc in warm light brown all the way around (sc evenly '
    'along the sides, 3 sc in each corner so it lies flat). Fasten off and weave in the end. '
    'This gives the light border you see around each side in the reference photo.')

# ---------------------------------------------------------------- SIDE 8: OLIVER-SIDEN
add('banner_oliver', 'DEL 2: OLIVER-SIDEN', 'PART 2: THE OLIVER SIDE')
add('oliver_lead',
    'Forsiden av kuben er Oliver selv, med en liten lyseblå volangkrage, samme teknikk som på '
    'rangelen og vognlenkens medaljong. Ingen sløyfe, akkurat som på Oliver selv, kragen er hans '
    'eneste pynt.',
    "The front of the cube is Oliver himself, with a little light blue ruffled collar, the "
    "same technique as on the rattle and the stroller toy's medallion. No bow, just like on "
    "Oliver himself, the collar is his only decoration.")
add('oliver_rows', [
...
add('oliver_ferdig',
    'Klipp av med god tråd igjen. Sy to små, runde ører (5 fm i magisk ring, avslutt, hekle 2 '
    'stk) øverst, den klassiske bamseformen i miniatyr, og brodér et lite ansikt.',
    'Cut, leaving a long tail. Sew on two small, round ears (5 sc in a magic ring, fasten off, '
    'make 2) on top, the classic teddy bear shape in miniature, and embroider a small face.')
add('oliver_krage',
    'Volangkragen: fest lyseblå tråd i nedre kant av hodet. *1 fm i neste maske, hopp over 1 '
    'maske, 5 stav i neste maske (en liten vifte), hopp over 1 maske*, gjenta hele veien rundt '
    'underkanten. Fest av. Dette er Olivers eneste pynt på panelet, ingen sløyfe. Sy til slutt '
    'Olivers hode godt fast midt på panelet.',
    "The ruffled collar: attach light blue yarn at the bottom edge of the head. *1 sc in the "
    "next stitch, skip 1 stitch, 5 dc in the next stitch (a little fan), skip 1 stitch*, repeat "
    "all the way around the bottom edge. Fasten off. This is Oliver's only decoration on the "
    "panel, no bow. Finally, sew Oliver's head securely onto the middle of the panel.")
...
add('speil_txt',
    ...
    'of the pocket.')
add('speil_ramme',
    'Blomsterrammen: fest lyseblå tråd direkte i ytterkanten av den innsydde speilsirkelen, og '
    ...
    'The flower frame: attach light blue yarn directly into the outer edge of the sewn-in '
...
add('form_lead',
    'Fire enkle, gjenkjennelige former, en fin start på formgjenkjenning for de minste, hentet '
    'fra tingene i referansebildet: hjerte, stjerne, blad og sky.',
    'Four simple, recognisable shapes, a nice start to shape recognition for little ones, taken '
    'from the reference photo: heart, star, leaf and cloud.')
...
add('pill_stjerne_form', 'STJERNEN (PUDDERROSA, MED ANSIKT)', 'THE STAR (POWDER PINK, WITH A FACE)')
add('stjerne_form_txt',
    'Hekle 5 fm i magisk ring. Fortsett rett inn i takkene: *1 fm, 3 lm, kjm i samme maske*, '
    'gjenta til alle 5 maskene har en takk. Fest av med god tråd igjen, press flatt. Brodér '
    'gjerne et lite, sovende ansikt (to lukkede øyne som streker og rosa kinn) midt på '
    'stjernen, akkurat som i referansebildet, før du syr den fast.',
    ...
    'press flat. Feel free to embroider a small, sleepy face (two closed eyes as little lines '
    'and pink cheeks) in the middle of the star, just like in the reference photo, before '
    'sewing it on.')
...
add('blad_form_txt',
    ...
    'med god tråd igjen, press flatt og sy fast.',
...
add('pill_sky_form', 'SKYEN (LYSEBLÅTT, MED STJERNER)', 'THE CLOUD (LIGHT BLUE, WITH STARS)')
add('sky_form_txt',
    'Hekle tre overlappende sirkler i lyseblått: (a) 6 fm i magisk ring, avslutt. (b) 6 fm i '
    'magisk ring, økn x 6 (12), avslutt. (c) 6 fm i magisk ring, økn x 6 (12), (1 fm, økn) x 6 '
    '(18), avslutt. Overlapp de tre sirklene og sy dem sammen til en liten skyform, press flatt '
    'og sy fast. Brodér gjerne noen få bittesmå stjerner i kremhvitt rundt skyen, akkurat som i '
    'referansebildet.',
    'Crochet three overlapping circles in light blue: (a) 6 sc in a magic ring, fasten off. (b) '
    ...
    'small cloud shape, press flat and sew on. Feel free to embroider a few tiny stars in cream '
    'around the cloud, just like in the reference photo.')

# ---------------------------------------------------------------- SIDE 11: LOMME-SIDEN
add('banner_lomme', 'DEL 5: LOMME-SIDEN', 'PART 5: THE POCKET SIDE')
add('lomme_lead',
    'En liten miniatyr-Oliver titter opp av en lyseblå lomme nederst på panelet, en liten '
    'tittelek-overraskelse.',
    'A tiny miniature Oliver peeks up out of a light blue pocket at the bottom of the panel, a '
    'little peekaboo surprise.')
add('lomme_txt',
    'Lommen: legg opp 12 lm + 1 vendemaske i lyseblått. Rad 1: 12 fm. Gjenta rad 1 i 8 rader '
    ...
    'opp.',
    'The pocket: chain 12 + 1 turning chain in light blue. Row 1: 12 sc. Repeat row 1 for 8 '
...
add('lomme_oliver',
    'Miniatyr-Oliver: 6 fm i magisk ring, varmt lyst brunt (6), økn x 6 (12), (1 fm, økn) x 6 '
    '(18), 1 omgang rett (18), mink x 6 (9), fyll svært lett. Fest av med god tråd igjen. Sy to '
    'bittesmå, runde ører og brodér et lite ansikt, akkurat som på Oliver-siden.',
    'Miniature Oliver: 6 sc in a magic ring, warm light brown (6), inc x 6 (12), (1 sc, inc) x '
    '6 (18), 1 round straight (18), dec x 6 (9), stuff very lightly. Fasten off, leaving a long '
    'tail. Sew on two tiny, round ears and embroider a small face, just like on the Oliver '
    'side.')
add('lomme_montering',
    'Sy miniatyr-Oliver godt fast rett bak lommeåpningen, litt høyere enn selve lommen, slik at '
    'bare hodet stikker opp av lommen, som om han titter frem. Oliver skal sys helt fast til '
    'panelet, ikke bare ligge løst nedi lommen.',
    'Sew the miniature Oliver securely just behind the pocket opening, a little higher than the '
    'pocket itself, so that only the head pokes up out of the pocket, as if he is peeking out. '
    'Oliver must be sewn completely onto the panel, not just placed loosely inside the pocket.')

# ---------------------------------------------------------------- SIDE 12: KNITRE-SIDEN
add('banner_flette', 'DEL 6: KNITRE-SIDEN', 'PART 6: THE CRINKLE SIDE')
add('flette_lead',
    'Denne siden gir en helt annen sans å utforske: lyd. Inni den lille, myke stjernehimmel-'
    'skyen legger du et knitrende stoff, en knitrefolie beregnet for babyprodukter, trygt sydd '
    'helt inne i skyen, slik at det knitrer akkurat der barnet klemmer på den.',
    'This side offers a completely different sense to explore: sound. Inside the little, soft '
    'starry-sky cloud you place a crinkling material, a crinkle sheet intended for baby '
    'products, safely sewn completely inside the cloud, so that it crinkles right where the '
    'child squeezes it.')
add('flette_hull',
    'Skyen, front og bak: hekle to like sett av tre overlappende sirkler i lyseblått, samme '
    'metode som skyen på Olivers vognlenke: (a) 6 fm i magisk ring. (b) 6 fm i magisk ring, økn '
    'x 6 (12). (c) 6 fm i magisk ring, økn x 6 (12), (1 fm, økn) x 6 (18). Overlapp og sy sammen '
    'de tre sirklene til en skyform. Hekle to like skyer totalt, én for framsiden og én for '
    'baksiden av puten. Brodér noen få bittesmå stjerner i kremhvitt rundt begge skyene, akkurat '
    'som i referansebildet.',
    'The cloud, front and back: crochet two matching sets of three overlapping circles in '
    'light blue, the same method as the cloud on Oliver\'s stroller toy: (a) 6 sc in a magic '
    'ring. (b) 6 sc in a magic ring, inc x 6 (12). (c) 6 sc in a magic ring, inc x 6 (12), (1 '
    'sc, inc) x 6 (18). Overlap and sew the three circles together into a cloud shape. Crochet '
    'two matching clouds in total, one for the front and one for the back of the pillow. '
    'Embroider a few tiny stars in cream around both clouds, just like in the reference photo.')
add('flette_snor',
...
add('sammensying_steg', [
    'Legg de seks ferdige panelene ut i den rekkefølgen du vil ha dem: Oliver-siden foran, '
    ...
    'Lay out the six finished panels in the order you want them: the Oliver side at the front, '
...
add('handtak_txt',
    'Tre et utvalg runde treperler og garnkledde kuler (pudderrosa, salviegrønt, kremhvitt, '
    'lyseblått og gult, akkurat som på Olivers vognlenke) på en kort, sterk bomullssnor, i den '
    'rekkefølgen du liker. Sy begge endene av snoren godt fast langs den øverste sømmen, mellom '
    'Oliver-siden og lomme-siden, slik at perlerekken danner en liten bue over toppen, som et '
    'håndtak.',
    "Thread a selection of round wooden beads and yarn-covered balls (powder pink, sage green, "
    "cream, light blue and yellow, just like on Oliver's stroller toy) onto a short, sturdy "
    "cotton cord, in whatever order you like. Sew both ends of the cord securely along the top "
    "seam, between the Oliver side and the pocket side, so the row of beads forms a small arch "
...
add('hjorner_txt',
    'Sy en treteetheringe godt fast i hver av de to loddrette sømmene som flankerer '
    'Oliver-siden (sømmen mot speil-siden på den ene siden, sømmen mot form-siden på den andre), '
    'slik at ringene henger som i referansebildet. Ringen skal sys fast med flere runder tett '
    ...
    "Oliver side (the seam towards the mirror side on one side, the seam towards the shapes "
    "side on the other), so the rings hang as in the reference photo. Each ring must be sewn on "
    "with several rounds of tight whip stitching, not just threaded loosely through the seam.")
add('dusker_txt',
...
add('montering_steg', [
    'Hekle de seks grunnkvadratene og kant dem alle i varmt lyst brunt.',
    'Hekle Oliver-siden, speil-siden, form-siden, lomme-siden og knitre-siden, hver på sitt '
    'eget grunnkvadrat. La bunnen være enkel.',
    ...
    'Fest de to hjørneringene og de to perleduskene i sømmene som flankerer Oliver-siden.',
...
add('montering_steg_en', [
    'Crochet the six base squares and edge them all in warm light brown.',
    'Crochet the Oliver side, the mirror side, the shapes side, the pocket side and the crinkle '
    ...
    'Attach the two corner rings and the two bead tassels into the seams flanking the Oliver '
    'side.',
...
add('smadeler_txt',
    ...
    'annen oppskrift i Oliver-kolleksjonen. Hvert eneste motiv, hver ring og hver perle skal sys '
    ...
    "other pattern in the Oliver collection. Every single motif, every ring and every bead must "
...
add('ferdig_txt',
    'Nå har du heklet den mest detaljerte oppskriften i hele Oliver-kolleksjonen. Godt jobbet, '
    'og god utforskning!',
    'Now you have crocheted the most detailed pattern in the whole Oliver collection. Well '
...
add('kolleksjon_liste',
    ['Oliver, den lille bjørnen', 'Olivers smokkelenke', 'Olivers rangle', 'Olivers vognlenke',
     'Olivers ballerinasko', 'Ellie, det lille dådyret', 'Ellies aktivitetsleke med sløyfe'],
    ['Oliver, the little bear', "Oliver's pacifier clip", "Oliver's rattle",
     "Oliver's stroller toy", "Oliver's ballerina shoes", 'Ellie, the little fawn',
     "Ellie's activity toy with a bow"])
...
def build(lang):
    ...
    pages.append(pg(f'''
<div class="coverimg"><img src="{ref_src}" alt="Olivers aktivitetsleke, stiluttrykk-referanse"></div>
...
<div class="figwrap"><img src="{alle_sider_src}" alt="Olivers aktivitetsleke, alle sidene" style="width:100mm"><div class="figcap">{t('caption_alle_sider')}</div></div>
''', 6))
...
''', 7))
    ...
    oliver_rows = T['oliver_rows']['no'] if lang == 'no' else T['oliver_rows_en']['no']
    pages.append(pg(f'''
{banner(t('banner_oliver'))}
<p>{t('oliver_lead')}</p>
{card(otab(oliver_rows, head3[lang]))}
{cme(t('oliver_ferdig'))}
{card('<p>' + t('oliver_krage') + '</p>')}
''', 8))
...
<div class="figwrap"><img src="{form_src}" alt="Form-siden" style="width:44mm"><div class="figcap">{t('caption_form')}</div></div>
''', 10))

    pages.append(pg(f'''
{sagep(t('pill_blad_form'))}
{card('<p>' + t('blad_form_txt') + '</p>')}
{sagep(t('pill_sky_form'))}
{card('<p>' + t('sky_form_txt') + '</p>')}
''', 11))
