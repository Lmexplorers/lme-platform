...
alle_sider_src = img_src('aktivitetsleke_alle_sider.jpg')
speil_src = img_src('aktivitetsleke_speil.jpg')
form_src = img_src('aktivitetsleke_form.jpg')
lomme_src = img_src('aktivitetsleke_lomme.jpg')
knitre_src = img_src('aktivitetsleke_knitre.jpg')
...
<div class="figwrap"><img src="{alle_sider_src}" alt="Ellies aktivitetsleke, alle sidene" style="width:100mm"><div class="figcap">{t('caption_alle_sider')}</div></div>
''', 6))
