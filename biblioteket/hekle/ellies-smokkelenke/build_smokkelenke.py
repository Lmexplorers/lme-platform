...
add('om_sikkerhet_kort',
    ...
    'lengden på denne oppskriften bevisst kort, og hele side 12 er viet sikkerhet. Les den siden '
    'før du hekler videre.',
    "A pacifier clip is something a baby has close to their face, often alone in a pram or bed. "
    "That's why this pattern's length is deliberately short, and all of page 12 is dedicated to "
...
add('kuler_lead',
    ...
    'head, for example alternating brown and cream, with wooden beads in between and one '
...
add('kuler_ferdig',
    ...
    'balls depends on the size of the pacifier ring and clip you use, always lay out the whole '
...
add('regler', [
    ...
    'Bruk kun en tre-kuleklips kjøpt spesielt til smokkelenker, med innkapslet fjærmekanisme, '
    'BPA-fri/CE-merket, aldri en generell binders eller kontorklype. Fest lenken til klipsen '
    'med mange, tette sting.',
