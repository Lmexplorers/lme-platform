...
add('kolleksjon_liste',
    ['Ellie, det lille dådyret', 'Pip, det lille pinnsvinet', 'Felix, den lille reven',
     ...
     'Mollys rangle', 'Lunas rangle', 'Olivers rangle', 'Ellies rangle', 'Ellies vognlenke',
...
<p class="small center" style="margin-top:-2mm;">{'Bildet viser Pip som stiluttrykk-referanse, ikke selve vognlenken.' if lang == 'no' else 'Photo shows Pip as a style reference, not the stroller toy itself.'}</p>
