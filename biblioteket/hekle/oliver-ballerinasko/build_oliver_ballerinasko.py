# -*- coding: utf-8 -*-
"""Genererer LME-hekleoppskrift 'Olivers ballerinasko' (norsk + engelsk) som HTML,
...
REF = BASE / 'oliver_ballerinasko_real.jpg'
...
# ---------------------------------------------------------------- SIDE 1
add('doctitle', 'Olivers ballerinasko, LME hekleoppskrift', "Oliver's Ballerina Shoes, LME crochet pattern")
add('ph2', 'LME HEKLEOPPSKRIFT&nbsp;&nbsp;|&nbsp;&nbsp;OLIVERS BALLERINASKO',
    "LME CROCHET PATTERN&nbsp;&nbsp;|&nbsp;&nbsp;OLIVER'S BALLERINA SHOES")
add('covertag', 'LME HEKLEOPPSKRIFT - BABY', 'LME CROCHET PATTERN - BABY')
add('covertitle', 'OLIVERS BALLERINASKO', "OLIVER'S BALLERINA SHOES")
add('subpill', 'LME BABY COLLECTION - WOODLAND DREAMS', 'LME BABY COLLECTION - WOODLAND DREAMS')
add('cover_desc',
    'Søte, klassiske babyballerinaer med rund tå, et lite bjørneansikt med runde ører på '
    'tåpartiet, T-stropp med lyseblå knapp, en lyseblå kant øverst og to labbeavtrykk brodert '
    'på sålen. Fem størrelser, fra prematur til 12 måneder. Ingen sløyfe, akkurat som resten av '
    'Olivers egen kolleksjon, den lyseblå kanten er hans eneste pynt. Heklet i de samme varme '
    'fargene som resten av Woodland Dreams.',
    "Sweet, classic baby ballerina shoes with a round toe, a little bear face with round ears "
    "on the toe, a T-bar strap with a light blue button, a light blue trim at the top and two "
    "little paw prints embroidered on the sole. Five sizes, from preemie to 12 months. No bow, "
    "just like the rest of Oliver's own collection, the light blue trim is his only "
    "decoration. Crocheted in the same warm colours as the rest of Woodland Dreams.")
...
# ---------------------------------------------------------------- SIDE 2
add('banner_om', 'OM OLIVERS BALLERINASKO', "ABOUT OLIVER'S BALLERINA SHOES")
add('pill_historien', 'DEL AV OLIVERS VERDEN', "PART OF OLIVER'S WORLD")
add('om_historien',
    'Olivers ballerinasko hører til LME Baby Collection "Woodland Dreams". Tenk deg at Oliver '
    'selv skulle hatt et par små, myke sko å tusle rundt i skogbunnen med, akkurat sånn er '
    'disse ballerinaene tenkt: runde, varme og klare for lek.',
    'Oliver\'s ballerina shoes belong to the LME Baby Collection "Woodland Dreams". Imagine '
    'Oliver himself with a little pair of shoes to toddle around the forest floor in, that is '
    'exactly the feeling these ballerinas are meant to have: round, warm and ready for play.')
add('pill_stil', 'STIL', 'STYLE')
add('om_stil',
    'Klassisk ballerinasko-form med rund tå og T-stropp, i varmt lyst brunt med lyseblå kant, '
    'akkurat som resten av Olivers egen kolleksjon. Ingen sløyfe her heller, den lyseblå kanten '
    'og knappen er skoens eneste pynt.',
    "A classic ballerina shoe shape with a round toe and T-bar strap, in warm light brown with "
    "a light blue trim, just like the rest of Oliver's own collection. No bow here either, the "
    "light blue trim and button are the shoe's only decoration.")
...
add('garn_txt',
    'Bystrikk Merino i varmt lyst brunt til selve skoen, en liten rest av kremhvitt til '
    'snuteflekken på bjørneansiktet, pluss lyseblått til kanten, T-stroppen, knappen og '
    'labbeavtrykkene, samme garnfamilie som resten av Olivers oppskrift.',
    "Bystrikk Merino in warm light brown for the shoe itself, a small leftover of cream for "
    "the muzzle patch on the bear face, plus light blue for the trim, the T-bar strap, the "
    "button and the paw prints, the same yarn family as the rest of Oliver's pattern.")
add('garn_alt',
...
add('oversikt_lead',
    'Hver sko har fem deler, ingen sløyfe. Hekle alt to ganger, én gang for hver fot.',
    'Each shoe has five parts, no bow. Crochet everything twice, once for each foot.')
add('oversikt_deler', [
    ('1. Sålen', 'oval bunn, med to broderte labbeavtrykk', '1. The sole',
     'oval base, with two embroidered paw prints'),
    ('2. Overdelen', 'sidene og tåpartiet', '2. The upper', 'the sides and toe'),
    ('3. Bjørneansiktet', 'lite hode med runde ører på tåpartiet', '3. The bear face',
     'a little head with round ears on the toe'),
    ('4. T-stroppen', 'med lyseblå knapp eller løkke', '4. The T-bar strap',
     'with a light blue button or loop'),
    ('5. Den lyseblå kanten', 'Olivers eneste pynt, øverst rundt skoen', '5. The light blue '
     'trim', "Oliver's only decoration, around the top of the shoe"),
])
...
add('sale_ferdig',
    'Ikke klipp av. Du fortsetter rett inn i overdelen fra samme tråd. Brodér to små '
    'labbeavtrykk i lyseblått midt på undersiden av hver såle, som i referansebildet, et lite '
    'detalj som viser hvem skoen tilhører når babyen løfter foten.',
    'Do not cut the yarn. You continue straight into the upper from the same thread. Embroider '
    'two small paw prints in light blue in the middle of the underside of each sole, as in the '
    "reference photo, a little detail that shows whose shoe it is when the baby lifts their "
    "foot.")
...
# ---------------------------------------------------------------- SIDE 10: BJØRNEANSIKTET
add('banner_bjorn', 'DEL 3: BJØRNEANSIKTET', 'PART 3: THE BEAR FACE')
add('bjorn_lead',
    'Et lite, flatt bjørnehode sys fast på tåpartiet av hver sko, med en liten kremhvit '
    'snuteflekk. Ingen sløyfe her, akkurat som på Oliver selv.',
    "A little, flat bear head is sewn onto the toe of each shoe, with a small cream muzzle "
    "patch. No bow here, just like on Oliver himself.")
add('bjorn_rows', [
...
add('bjorn_ferdig',
    'Fest av med god tråd igjen, og press hodet flatt. Hekle to små, runde ører (6 fm i magisk '
    'ring, økn x 6 (12), fest av, hekle 2 stk per sko), den klassiske bamseformen i miniatyr, og '
    'sy dem fast øverst på hodet, med litt av overkanten stikkende opp over skoens overkant, '
    'akkurat som i referansebildet. Hekle en liten kremhvit snuteflekk (5 fm i magisk ring, fest '
    'av) og sy den fast nederst på hodet. Brodér et lite ansikt (to øyne, en liten nese og '
    'gjerne rosa kinn) med samme teknikk som Olivers andre motiver. Sy bjørneansiktet godt fast '
    'midt på tåpartiet av skoen. Ingen sløyfe mellom ørene, det er den lyseblå kanten som er '
    'skoens pynt.',
    "Fasten off, leaving a long tail, and press the head flat. Crochet two small, round ears (6 "
    "sc in a magic ring, inc x 6 (12), fasten off, make 2 per shoe), the classic teddy bear "
    "shape in miniature, and sew them onto the top of the head, with a bit of the top peeking "
    "up over the top edge of the shoe, just like in the reference photo. Crochet a small cream "
    "muzzle patch (5 sc in a magic ring, fasten off) and sew it onto the bottom of the head. "
    "Embroider a small face (two eyes, a little nose, and pink cheeks if you like) using the "
    "same technique as Oliver's other motifs. Sew the bear face securely onto the middle of the "
    "toe of the shoe. No bow between the ears, the light blue trim is the shoe's decoration.")

# ---------------------------------------------------------------- SIDE 11: T-STROPP OG LUKKING
add('banner_tstropp', 'DEL 4: T-STROPPEN OG LUKKINGEN', 'PART 4: THE T-BAR STRAP AND CLOSURE')
add('tstropp_lead',
    'T-stroppen går fra midt på tåpartiet, opp og over vristen, til den ene siden, i lyseblått.',
    'The T-bar strap runs from the middle of the toe opening, up and over the instep, to one '
    'side, in light blue.')
add('tstropp_txt',
    'Fest lyseblå tråd midt foran på åpningens nederste kant. Hekle en kort stropp av '
    'fastmasker rett over vristen, i en lengde som passer størrelsen (prøv mot foten). Fest '
    'stroppen på den ene siden av skoen med noen faste sting.',
    'Attach light blue yarn in the middle front of the bottom edge of the opening. Crochet a '
    'short strap of single crochet straight over the instep, in a length that suits the size '
    '(try it against the foot). Attach the strap to one side of the shoe with a few secure '
    'stitches.')
...
add('lukking_alt',
    [('Uten knapp (anbefalt for de minste)', 'La stroppen ende i en liten heklet løkke, og sy '
      ...
      'minste størrelsene.'),
     ('Med myk heklet knapp i lyseblått', 'Hekle en liten flat "knapp" i lyseblått (5 fm i '
      'magisk ring, avslutt), akkurat som i referansebildet, og sy den godt og fast til siden '
      'av skoen. Tre stroppens løkke over knappen. Bruk aldri en hard plast- eller '
      'metallknapp, og sjekk at knappen sitter godt fast før hver bruk.')],
    [('Without a button (recommended for the smallest sizes)', 'Let the strap end in a small '
     ...
     ('With a soft crocheted button in light blue', 'Crochet a small flat "button" in light '
      'blue (5 sc in a magic ring, fasten off), just like in the reference photo, and sew it '
      'securely onto the side of the shoe. Slip the strap\'s loop over the button. Never use a '
      'hard plastic or metal button, and check that the button is firmly attached before every '
      'use.')])

# ---------------------------------------------------------------- SIDE 12: DEN LYSEBLÅ KANTEN
add('banner_picot', 'DEL 5: DEN LYSEBLÅ KANTEN', 'PART 5: THE LIGHT BLUE TRIM')
add('picot_lead',
    'Den lyseblå picotkanten er Olivers eneste pynt på skoen, i stedet for en sløyfe, akkurat '
    'som resten av hans egen kolleksjon. Den gir samtidig skoen et klassisk, litt '
    'kniplingaktig ballerina-utseende, og hekles helt til slutt rundt hele den øvre åpningen.',
    "The light blue picot trim is Oliver's only decoration on the shoe, in place of a bow, "
    "just like the rest of his own collection. It also gives the shoe a classic, slightly "
    "lace-like ballerina look, and is crocheted last, all the way around the top opening.")
add('picot_txt',
    'Fest lyseblå tråd hvor som helst langs overkanten. Hekle *1 fm i neste maske, 3 lm, kjm '
    'tilbake i den første av de tre luftmaskene (én picot laget)*, gjenta rundt hele åpningen. '
    'Avslutt med en kjedemaske og fest tråden godt på innsiden.',
    'Attach light blue yarn anywhere along the top edge. Crochet *1 sc in the next stitch, 3 '
    'ch, sl st back into the first of the three chains (one picot made)*, repeat all the way '
    'around the opening. Finish with a slip stitch and fasten the yarn securely on the inside.')

# ---------------------------------------------------------------- SIDE 13: MONTERING
add('banner_montering', 'MONTERING, STEG FOR STEG', 'ASSEMBLY, STEP BY STEP')
add('montering_steg', [
    'Hekle sålen og overdelen i ett, for begge skoene, og brodér to labbeavtrykk i lyseblått på '
    'hver såle.',
    'Hekle bjørneansiktene med runde ører og snuteflekk, og brodér ansiktene, og sy ett fast på '
    'tåpartiet av hver sko.',
    'Hekle T-stroppen på hver sko i lyseblått, og fest med valgt lukking (uten knapp, eller med '
    'myk heklet knapp i lyseblått).',
    'Hekle den lyseblå picotkanten rundt overkanten på begge skoene.',
...
add('montering_steg_en', [
    'Crochet the sole and upper as one piece, for both shoes, and embroider two paw prints in '
    'light blue on each sole.',
    'Crochet the bear faces with round ears and a muzzle patch, and embroider the faces, and '
    'sew one onto the toe of each shoe.',
    'Crochet the T-bar strap on each shoe in light blue, and fasten with your chosen closure '
    '(no button, or a soft crocheted button in light blue).',
    'Crochet the light blue picot trim around the top of both shoes.',
...
add('sikkerhet_txt',
    ['Ingen deler limes. Alt sys fast med sterk, tvinnet bomullstråd og mange, tette sting.',
     ...
     'Sjekk skoene jevnlig for slitasje: løse tråder, bjørneansikt, ører eller knapper som '
     'sitter løst. Kast eller reparer umiddelbart hvis noe er galt.',
    ...
    ['No parts are glued. Everything is sewn on with strong, twisted cotton thread and plenty '
     ...
     'Check the shoes regularly for wear: loose threads, a loose bear face, ears or buttons '
     'that feel loose. Discard or repair immediately if anything is wrong.',
...
add('ferdig_txt',
    'Nå har du heklet et lite par ballerinasko til Oliver-kolleksjonen. Perfekt til bilder, '
    'gaver og hverdagskos!',
    "Now you have crocheted a little pair of ballerina shoes for the Oliver collection. Perfect "
...
add('kolleksjon_liste',
    ['Oliver, den lille bjørnen', 'Olivers smokkelenke', 'Olivers rangle', 'Olivers vognlenke',
     'Olivers aktivitetsleke', 'Ellie, det lille dådyret', 'Pip, det lille pinnsvinet',
     'Felix, den lille reven', 'Molly, det lille lammet', 'Luna, den lille kaninen'],
    ['Oliver, the little bear', "Oliver's pacifier clip", "Oliver's rattle",
     "Oliver's stroller toy", "Oliver's activity toy", 'Ellie, the little fawn',
     'Pip, the little hedgehog', 'Felix, the little fox', 'Molly, the little lamb',
     'Luna, the little bunny'])
...
def build(lang):
    ...
    pages.append(pg(f'''
<div class="coverimg"><img src="{ref_src}" alt="Olivers ballerinasko, stiluttrykk-referanse"></div>
...
''', 9))
    ...
    bjorn_rows = T['bjorn_rows']['no'] if lang == 'no' else T['bjorn_rows_en']['no']
    pages.append(pg(f'''
{banner(t('banner_bjorn'))}
<p>{t('bjorn_lead')}</p>
{card(otab(bjorn_rows, head3[lang]))}
{cme(t('bjorn_ferdig'))}
''', 10))
