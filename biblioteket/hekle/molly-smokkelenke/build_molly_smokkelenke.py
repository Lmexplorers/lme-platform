...
add('cover_desc',
    'En liten smokkelenke med et forenklet lamhode inspirert av Molly, med en liten krøllete '
    'løkkemasket topp og en smørgul sløyfe, og noen myke heklede kuler. Heklet i de samme '
    'naturfargene som resten av kolleksjonen. Maks lengde er satt for å følge gjeldende '
    'sikkerhetsanbefaling for smokkeholdere.',
    "A little pacifier clip with a simplified lamb head inspired by Molly, with a little curly "
    "loop-stitch topknot and a butter yellow bow, and a few soft crocheted balls. Crocheted in "
...
add('oversikt_deler', [
    ...
    ('2. Sløyfen', 'smørgul, mellom ørene', '2. The bow', 'butter yellow, between the ears'),
...
# ---------------------------------------------------------------- SIDE 8: SLØYFEN
add('banner_sloyfe', 'DEL 2: SLØYFEN', 'PART 2: THE BOW')
...
add('kuler_lead',
    ...
    'gjerne i en rytme av kremhvitt og smørgult. Husk: total lengde skal aldri bli mer enn '
    '22 cm.',
    'Crochet as many balls as you need to fill out the length between the clip and the lamb '
    'head, for example alternating cream and butter yellow. Remember: the total length must '
    'never exceed 22 cm.')
add('kuler_rows', [
    ('1', '6 fm i magisk ring', 6),
    ('2', 'økn x 6', 12),
...
add('montering_steg', [
    'Tre eller sy kulene (og eventuelle perler) i ønsket rekkefølge på en kort, sterk '
    'bomullssnor eller direkte sammen med tett heftesting mellom hver del.',
    'Hekle ulltoppen på lamhodet, og sy sløyfen fast mellom ørene, oppå ulltoppen.',
...
add('montering_steg_en', [
    'Thread or sew the balls (and any beads) in the order you want, on a short, strong '
    'cotton cord, or sew them directly together with tight running stitch between each '
    'piece.',
    'Crochet the wool topknot onto the lamb head, and sew the bow on between the ears, on '
    'top of the topknot.',
    ...
    'or two.',
    'Sew the finished clip securely onto the round wooden clip, with plenty of tight '
    'stitches or a secure, metal-free fastening mechanism designed for soother holders.',
