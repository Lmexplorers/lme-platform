...
add('cover_desc',
    'En liten vognlenke med Felix midt på, omgitt av sky, sol, blad, blomst, stjerne og '
    ...
    "A little stroller toy with Felix in the middle, surrounded by a cloud, sun, leaf, flower, "
...
add('om_historien',
    ...
    'lenken, omgitt av tingene han elsker fra skogkanten og himmelen over skogen: sol, sky, '
    ...
    "in the middle of the toy, surrounded by the things he loves from the forest edge and the "
...
add('garn_txt',
    'Bystrikk Merino (rustoransje og kremhvitt) og rester av pudderrosa og salviegrønt, pluss '
    "litt gult til solen, samme garnfamilie som resten av Felix' oppskrift.",
    "Bystrikk Merino (rust orange and cream) and leftover powder pink and sage green, plus a "
    "little yellow for the sun, the same yarn family as the rest of Felix's pattern.")
add('garn_alt',
...
add('utstyr', [
    ...
    ('Litt polyesterfiber til fyll', 'kun til Felix-medaljongen og minihalen'),
...
add('ord_lead',
    "Motivene bruker fastmasker, stav og halvstav, akkurat som Felix' smokkelenke.",
    "The motifs use single, double and half double crochet, just like Felix's pacifier clip.")
...
add('oversikt_lead',
    'Syv motiver hekles hver for seg og festes tett langs en kort hovedstreng, med Felix i '
    'midten, pluss to sideringer med kuler:',
    'Seven motifs are crocheted separately and attached close together along a short main '
    'strand, with Felix in the middle, plus two side rings with balls:')
add('oversikt_deler', [
    ('1. Felix-medaljongen', 'midtmotivet, med en mini tofarget hale', '1. The Felix medallion',
     'the centre motif, with a mini two-tone tail'),
    ...
    ('7. Sommerfuglen', 'pudderrosa og rustoransje', '7. The butterfly',
     'powder pink and rust orange'),
...
add('medaljong_lead',
    "Midtmotivet er en liten, flat utgave av Felix' hode, rustoransje, lett stoppet slik at "
    'den får litt form uten å bli tung.',
    "The centre motif is a small, flat version of Felix's head, rust orange, lightly stuffed "
...
add('medaljong_ferdig',
    ...
    '12 fm, mink x 6, fyll lett) og sy den til bakhodet, og brodér et lite ansikt akkurat som '
    'på rangelen og smokkelenken.',
    ...
    'round of 12 sc, dec x 6, stuff lightly) and sew it onto the back of the head, and '
    "embroider a small face just like on the rattle and pacifier clip.")
...
add('sommerfugl_txt',
    ...
    'stk). Hekle en liten kropp i rustoransje: 5 lm, kjm i hver lm tilbake. Legg kroppen '
    ...
    '(make 2). Crochet a small body in rust orange: 5 ch, sl st in each ch back across. '
...
add('sideringer_ferdig',
    ...
    'selve ringen godt fast tett inntil hovedstrengen på hver side av Felix, med flere runder '
    ...
    'Felix, with several rounds of whip stitching, not just threaded loosely onto the cord.')
...
add('montering_lead',
    ...
    'Felix i midten, før du fester noe permanent.',
    'Lay out all seven motifs and the two side rings in the order you want, with Felix in '
...
add('montering_steg', [
    ...
    'Sy Felix-medaljongen fast midt på snoren.',
    'Fordel de seks andre motivene jevnt på hver side av Felix, tett inntil hovedstrengen, og '
    'sy dem godt fast.',
...
add('montering_steg_en', [
    ...
    'Sew the Felix medallion onto the middle of the cord.',
    'Distribute the other six motifs evenly on each side of Felix, close against the main '
...
add('foto_captions',
    ['Alle sju motivene', 'Felix midt på snoren', 'Motivene fordelt', 'Ferdig montert lenke'],
    ['All seven motifs', 'Felix in the middle of the cord', 'The motifs spread out',
...
add('kolleksjon_liste',
    ...
    ['Ellie, the little fawn', 'Pip, the little hedgehog', 'Felix, the little fox',
     ...
     "Ellie's rattle", "Pip's stroller toy", "Ellie's stroller toy", "Ellie's ballerina shoes",
