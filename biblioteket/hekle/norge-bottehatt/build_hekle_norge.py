...
PHOTO = pathlib.Path('/root/.claude/uploads/8a2defc1-69f7-5b9a-9a21-28d0d3730f69/783ff52f-IMG_2685.png')
...
def page(body, num, right_label='LME STRIKK'):
  ...
  <div class="phead">
    ...
    <div class="ph2">LME HEKLEOPPSKRIFT&nbsp;&nbsp;|&nbsp;&nbsp;NORGE-BØTTEHATT</div>
  </div>
...
# ============ SIDE 1: FORSIDE ============
pages.append(page(f'''
<div class="coverimg"><img src="{photo_src}" alt="Heklet NORGE-bøttehatt"></div>
...
{card('<p class="center">En rød bøttehatt heklet i bomull, med "NORGE" i hvite blokkbokstaver '
...
front_strip = strip_svg([
    ('13 m rød',13,'sp'),('N',9,'x'),('',2,'sp'),('O',9,'x'),('',2,'sp'),('R',9,'x'),('',2,'sp'),
    ('G',9,'x'),('',2,'sp'),('E',9,'x'),('12 m rød',12,'sp'),
...
<div class="chartrow tight">
{chart_svg(LETTERS5['G'], cell=12)}{chart_svg(LETTERS5['E'], cell=12)}
</div>
{pink('PLASSERING RUNDT (78 MASKER)')}
{card(f'<div class="stripwrap">{front_strip}</div>'
  + ul([
  'Start ved maskemarkøren (midt bak). Hekle først 13 røde masker.',
  'Så hekler du bokstavene med 2 røde masker mellom hver, og avslutter med 12 røde masker.',
...
{cme('Gratulerer! Nå har du heklet din egen NORGE-hatt. Heia Norge!')}
...
<title>NORGE-bøttehatt, LME hekleoppskrift</title>
<style>{css}</style></head>
<body>{''.join(pages)}</body></html>'''

(BASE / 'hekle_norge.html').write_text(doc, encoding='utf-8')
