...
add('cover_desc',
    'En liten smokkelenke med et forenklet kaninhode inspirert av Luna, med to små, avlange '
    'ører som en miniatyr av hennes lange ører, en rosa sløyfe, og noen myke heklede kuler. '
    ...
    "A little pacifier clip with a simplified bunny head inspired by Luna, with two small, "
    "elongated ears as a miniature of her long ears, a pink bow, and a few soft crocheted "
    "balls. Crocheted in the same natural colours as the rest of the collection. Maximum "
...
add('oversikt_deler', [
    ...
    ('2. Sløyfen', 'rosa, mellom ørene', '2. The bow', 'pink, between the ears'),
...
add('kuler_lead',
    ...
    'gjerne i en rytme av varmt grått og rosa. Husk: total lengde skal aldri bli mer enn 22 '
    'cm.',
    'Crochet as many balls as you need to fill out the length between the clip and the bunny '
    'head, for example alternating warm grey and pink. Remember: the total length must never '
    'exceed 22 cm.')
add('kuler_rows', [
    ('1', '6 fm i magisk ring', 6),
    ('2', 'økn x 6', 12),
...
add('montering_steg', [
    ...
    'Sy sløyfen fast mellom ørene på kaninhodet.',
...
add('montering_steg_en', [
    ...
    'piece.',
    'Sew the bow on between the ears on the bunny head.',
