...
REF = BASE.parent / 'luna-smokkelenke' / 'luna_face_ref.jpg'
...
<p class="small center" style="margin-top:-2mm;">{'Bildet viser Lunas ansikt som stiluttrykk-referanse, ikke selve vognlenken.' if lang == 'no' else "Photo shows Luna's face as a style reference, not the stroller toy itself."}</p>
