...
add('cover_desc',
    'En liten vognlenke med Luna midt på, omgitt av sky, sol, blad, blomst, stjerne og '
    ...
    "A little stroller toy with Luna in the middle, surrounded by a cloud, sun, leaf, flower, "
...
add('garn_txt',
    'Bystrikk Merino (varmt grått og rosa) og rester av kremhvitt og salviegrønt, pluss litt '
    "gult til solen, samme garnfamilie som resten av Lunas oppskrift.",
    "Bystrikk Merino (warm grey and pink) and leftover cream and sage green, plus a little "
    "yellow for the sun, the same yarn family as the rest of Luna's pattern.")
add('garn_alt',
...
add('utstyr', [
    ...
    ('Litt polyesterfiber til fyll', 'kun til Luna-medaljongen'),
...
add('ord_lead',
    "Motivene bruker fastmasker, stav og halvstav, akkurat som Lunas smokkelenke.",
    "The motifs use single, double and half double crochet, just like Luna's pacifier clip.")
...
add('oversikt_lead',
    'Syv motiver hekles hver for seg og festes tett langs en kort hovedstreng, med Luna i '
    'midten, pluss to sideringer med kuler:',
    'Seven motifs are crocheted separately and attached close together along a short main '
    'strand, with Luna in the middle, plus two side rings with balls:')
add('oversikt_deler', [
    ('1. Luna-medaljongen', 'midtmotivet, med avlange mini-ører', '1. The Luna medallion',
     'the centre motif, with elongated mini ears'),
    ...
    ('7. Sommerfuglen', 'pudderrosa og varmt grått', '7. The butterfly', 'powder pink and '
     'warm grey'),
...
add('medaljong_lead',
    "Midtmotivet er en liten, flat utgave av Lunas hode, varmt grått, lett stoppet slik at "
    'den får litt form uten å bli tung.',
    "The centre motif is a small, flat version of Luna's head, warm grey, lightly stuffed so "
...
add('medaljong_ferdig',
    ...
    'lange ører. Brodér til slutt et lite ansikt akkurat som på rangelen og smokkelenken.',
    ...
    '(make 2), and sew them onto the top, hanging gently downward as a miniature of '
    "Luna's long ears. Finally, embroider a small face just like on the rattle and pacifier "
    "clip.")
...
add('sommerfugl_txt',
    ...
    'stk). Hekle en liten kropp i varmt grått: 5 lm, kjm i hver lm tilbake. Legg kroppen '
    ...
    '(make 2). Crochet a small body in warm grey: 5 ch, sl st in each ch back across. '
...
add('sideringer_ferdig',
    ...
    'selve ringen godt fast tett inntil hovedstrengen på hver side av Luna, med flere runder '
    ...
    'Luna, with several rounds of whip stitching, not just threaded loosely onto the cord.')
...
add('montering_lead',
    ...
    'Luna i midten, før du fester noe permanent.',
    'Lay out all seven motifs and the two side rings in the order you want, with Luna in '
...
add('montering_steg', [
    ...
    'Sy Luna-medaljongen fast midt på snoren.',
    'Fordel de seks andre motivene jevnt på hver side av Luna, tett inntil hovedstrengen, og '
    'sy dem godt fast.',
...
add('montering_steg_en', [
    ...
    'Sew the Luna medallion onto the middle of the cord.',
    'Distribute the other six motifs evenly on each side of Luna, close against the main '
...
add('foto_captions',
    ['Alle sju motivene', 'Luna midt på snoren', 'Motivene fordelt', 'Ferdig montert lenke'],
    ['All seven motifs', 'Luna in the middle of the cord', 'The motifs spread out',
...
add('kolleksjon_liste',
    ['Ellie, det lille dådyret', 'Pip, det lille pinnsvinet', 'Felix, den lille reven',
     ...
     "Felix' vognlenke", 'Mollys vognlenke', 'Ellies vognlenke', 'Ellies ballerinasko',
