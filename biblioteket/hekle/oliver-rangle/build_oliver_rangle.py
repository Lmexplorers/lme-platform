...
<p class="small center" style="margin-top:-2mm;">{'Bildet viser Oliver som stiluttrykk-referanse, ikke selve rangelen.' if lang == 'no' else 'Photo shows Oliver as a style reference, not the rattle itself.'}</p>
