...
alle_sider_src = img_src('pip_alle_sider.jpg')
speil_src = img_src('pip_speil.jpg')
form_src = img_src('pip_form.jpg')
detalj_src = img_src('pip_detalj.jpg')
lomme_src = img_src('pip_lomme.jpg')
knitre_src = img_src('pip_knitre.jpg')
...
add('caption_detalj', 'Hjerte, blad, minispeil og minisky, stiluttrykk-referanse.',
    'Heart, leaf, mini mirror and mini cloud, style reference.')
add('caption_lomme', 'Lomme-siden med miniatyr-Pip, stiluttrykk-referanse.',
    'The pocket side with miniature Pip, style reference.')
...
<div class="figwrap"><img src="{alle_sider_src}" alt="Pips aktivitetsleke, alle sidene" style="width:100mm"><div class="figcap">{t('caption_alle_sider')}</div></div>
''', 6))
...
<div class="figwrap"><img src="{detalj_src}" alt="Hjerte, blad, minispeil og minisky" style="width:44mm"><div class="figcap">{t('caption_detalj')}</div></div>
''', 11))
