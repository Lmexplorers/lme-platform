...
PRODUCTS = [
  ...
  },
  {
    ...
    'sub_no': 'Et trekantet skaut i rødt bomullsgarn, med bølger og flaggstriper rundt hele kanten og det norske flagget på. I-cord-snorer festes i sidene foran og knytes bak, under spissen. Passer til bøttehattene.',
    'sub_en': 'A triangular kerchief in red cotton yarn, with waves and flag stripes around the whole edge and the Norwegian flag on it. I-cord ties attach at the front sides and tie at the back, under the point. Matches the bucket hats.',
