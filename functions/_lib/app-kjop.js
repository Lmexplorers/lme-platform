...
export const APP_KJOP = {
  ...
  ikkeInkludert: {
    no: "Ingen AI-kvote følger med. Du legger inn dine egne nøkler under Innstillinger, fra OpenAI eller Gemini til bilder, og Claude til tekst. Da betaler du AI-en direkte for det du lager, og ingenting til meg hver måned. For at appen skal legge ut for deg, trenger du i tillegg en egen Blotato-konto med betalt plan. Den rimeligste planen deres koster 29 dollar i måneden, altså rundt 300 kroner avhengig av dollarkursen, og API-tilgangen appen bruker følger med fra den. Gratisversjonen og prøveperioden har alt annet, men ikke API-et. Gjeldende priser: blotato.com/pricing. Det er den som gir appen lov til å poste til Instagram, Facebook og TikTok, og API-et følger ikke med gratisversjonen deres. Uten den koblingen publiserer ikke appen, og da er den ikke lenger en autopilot. Alle stegene, med lenker: lmexplorers.com/autopilot-nokler",
    en: "No AI quota is included. You add your own keys under Settings, from OpenAI or Gemini for images, and Claude for text. You then pay the AI directly for what you make, and nothing to me every month. For the app to post for you, you also need your own Blotato account on a paid plan. Their cheapest plan is 29 dollars a month, and the API access the app uses is included from that one. The free version and the trial have everything else, but not the API. Current prices: blotato.com/pricing. That is what lets the app post to Instagram, Facebook and TikTok, and their free version does not include the API. Without that connection the app does not publish, and then it is no longer an autopilot. Every step, with links: lmexplorers.com/autopilot-nokler",
  },
};
