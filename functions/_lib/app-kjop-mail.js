...
export async function sendAppKjopMail(env, { to, name, lang, betaltMed }) {
  ...
  const inner = en
    ? '<h2 style="font-size:21px;margin:0 0 14px;">The app is yours</h2>' +
      ...
      "<p>For images, get a key at <a href=\"https://platform.openai.com/api-keys\" style=\"color:#E91E89;\">platform.openai.com/api-keys</a>. For text, at <a href=\"https://console.anthropic.com/settings/keys\" style=\"color:#E91E89;\">console.anthropic.com/settings/keys</a>. Both need a small top-up under Billing before the key works. Posting for you runs through <a href=\"https://my.blotato.com\" style=\"color:#E91E89;\">Blotato</a>, and needs a paid plan there, from 29 dollars a month, since their free version does not include the API. Without it the app cannot publish.</p>" +
