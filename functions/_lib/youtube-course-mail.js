  ...
  no: {
    ...
    day14: (name) => ({
      ...
      html: wrap(
        ...
        '<p><strong>Få verktøyene</strong>: oppgrader planen din og lås opp Reel Studio og LME Content Studio, så AI gjør enda mer av jobben for deg.</p>' +
  ...
  en: {
    ...
    day14: (name) => ({
      ...
      html: wrap(
        ...
        '<p><strong>Get the tools</strong>: upgrade your plan and unlock Reel Studio and LME Content Studio, so AI does even more of the work for you.</p>' +
