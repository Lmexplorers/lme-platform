...
export const MIA_TEO_SERIE_KOMPLETT = {
  ...
  contains: [
    ...
    { no: "Følelsestermometer og ro-strategier, hefte 3–6 år og 6–9 år", en: "" },
  ],
  pageCount: 181,
  language: ["nb"],
  fileFormat: ["pdf"],
...
export const MIA_TEO_TERMOMETER_3_6 = {
  ...
  published: true,
  featured: false,
  title: { no: "Følelsestermometer og ro-strategier med Mia & Teo, 3–6 år", en: "" },
  subtitle: {
  ...
  competencyGoals: [
    { no: "Barnet kan peke på hvor sterk en følelse kjennes, be om hjelp, pause, plass eller ro med et kort, og velge blant kjente strategier sammen med en voksen.", en: "" },
  ],
  contains: [
    { no: "To følelsestermometre: et enkelt med tre nivåer og et med fem nivåer", en: "" },
    { no: "\"Jeg trenger\"-kort: hjelp, pause, plass og ro, til fargelegging og utklipping", en: "" },
    { no: "Tolv strategikort (tre ark) med konkrete ro-strategier", en: "" },
    { no: "\"Mine tre valg\", \"Mitt rolige sted\" og en øvingsside for voksen og barn sammen", en: "" },
    { no: "Veiledning til den voksne om samregulering", en: "" },
  ],
  pageCount: 17,
  language: ["nb"],
  fileFormat: ["pdf"],
  ...
  montessoriArea: {
    area: { no: "Sansene / kroppsbevissthet: regulering og ro-strategier", en: "" },
    presentation: {
    ...
    prerequisites: { no: "Ingen spesielle forkunnskaper. Kan gjerne kombineres med «Mia & Teo utforsker følelsene» og «Følelsene i kroppen».", en: "" },
    directPurpose: { no: "Sette ord på styrken i en følelse og velge en konkret strategi som kan hjelpe kroppen.", en: "" },
    indirectPurpose: { no: "Bygge tidlig selvregulering gjennom trygg samregulering med en voksen.", en: "" },
    controlOfError: { no: "Ingen fasit. Barnet og den voksne vurderer sammen om en strategi hjalp, hjalp litt eller ikke hjalp nå.", en: "" },
    extension: { no: "Kombiner med de andre produktene i serien for et helhetlig følelsesspråk.", en: "" },
  },
  license: "privat",
  priceType: "betalt",
  price: { no: "89 kr", en: "" },
...
export const MIA_TEO_TERMOMETER_6_9 = {
  ...
  published: true,
  featured: false,
  title: { no: "Følelsestermometer og ro-strategier med Mia & Teo, 6–9 år", en: "" },
  subtitle: {
  ...
  resourceType: ["arbeidshefte", "aktivitetskort", "larerveiledning"],
  competencyGoals: [
    { no: "Barnet kan legge merke til tidlige kroppssignaler, vurdere styrken i en følelse fra 1 til 5, velge og teste egne strategier, og lage en personlig reguleringsplan.", en: "" },
  ],
  contains: [
    { no: "Følelsestermometer 1–5 og en side for tidlige signaler", en: "" },
    { no: "Strategimeny i fem kategorier: kropp, sanser, miljø, kontakt og problem", en: "" },
    { no: "Tjue strategikort (fem ark) til utklipping og sortering", en: "" },
    { no: "Pausepass, «jeg trenger hjelp»-kort og «stopp»-kort til å tilpasse selv", en: "" },
    { no: "\"Hva virker for meg?\", \"Sammenlign to strategier\" og en personlig reguleringsplan", en: "" },
    { no: "Veiledning til den voksne om samregulering og observasjon", en: "" },
  ],
  pageCount: 22,
  language: ["nb"],
  fileFormat: ["pdf"],
  ...
  montessoriArea: {
    area: { no: "Sansene / kroppsbevissthet: regulering og reguleringsplan", en: "" },
    presentation: {
    ...
    prerequisites: { no: "Kan brukes alene eller som en videreføring av «Følelsestermometer og ro-strategier 3–6 år» og de andre produktene i serien.", en: "" },
    directPurpose: { no: "Vurdere styrken i en følelse, gjenkjenne tidlige signaler, og velge en realistisk strategi.", en: "" },
    indirectPurpose: { no: "Bygge selvregulering, selvforståelse og evne til å evaluere egne strategier over tid.", en: "" },
    controlOfError: { no: "Ingen fasit. Barnet vurderer selv om en strategi hjalp, og kan alltid teste noe annet.", en: "" },
    extension: { no: "Kombiner med de andre produktene i serien for et helhetlig følelsesspråk.", en: "" },
  },
  license: "privat",
  priceType: "betalt",
...
export const MIA_TEO_SPRAKLEK_3_6 = {
  ...
  published: true,
  featured: false,
  title: { no: "Språklek med Mia & Teo, lytt, lek, les og fortell, 3–6 år", en: "" },
  subtitle: {
  ...
  resourceType: ["aktivitetskort", "larerveiledning"],
  competencyGoals: [
    { no: "Barnet kan leke med rim, stavelser og lyder i ord, og bruke enkle begreper for plassering, motsetning og rekkefølge muntlig.", en: "" },
  ],
  contains: [
    { no: "Tolv aktiviteter: rimord, klappe stavelser, førstelyd, sortere ord, stor og liten, motsetninger, på boksen, under bordet, hva skjer først, fortell en historie, hva passer ikke, og bilde og gjenstand", en: "" },
    { no: "Tolv språkkort (tre ark) til å velge og klippe ut", en: "" },
    { no: "\"Mine rimord\"- og \"Min fortelling\"-arbeidsark for tegning og tidlig skriving", en: "" },
    { no: "Veiledning til den voksne om å følge barnets tempo og leke med språket", en: "" },
  ],
  pageCount: 20,
  language: ["nb"],
  fileFormat: ["pdf"],
  ...
  differentiation: {
    no: "For 3–6 år: bruk muntlig lek, konkreter og korte økter. La barnet bruke hele språkrepertoaret sitt, også flere språk, og bygg bro mellom dem.", en: "",
  },
  montessoriArea: {
    area: { no: "Språk: muntlig lek og tidlig begrepsforståelse", en: "" },
    presentation: {
    ...
    prerequisites: { no: "Ingen spesielle forkunnskaper. Kan brukes muntlig, uten lesing.", en: "" },
    directPurpose: { no: "Utforske lyd, rytme og betydning i muntlig språk.", en: "" },
    indirectPurpose: { no: "Bygge ordforråd, lytteferdigheter og grunnlag for senere lese- og skriveglede.", en: "" },
    controlOfError: { no: "Barnet hører selv om et ord rimer, en stavelse stemmer eller et motsetningspar passer sammen.", en: "" },
    extension: { no: "Finn flere rim, motsetninger eller fortellinger i hverdagen sammen med barnet.", en: "" },
  },
  license: "privat",
  priceType: "betalt",
  price: { no: "89 kr", en: "" },
...
export const MIA_TEO_SPRAKLEK_6_9 = {
  ...
  published: true,
  featured: false,
  title: { no: "Språklek med Mia & Teo, lytt, lek, les og fortell, 6–9 år", en: "" },
  subtitle: {
  ...
  resourceType: ["aktivitetskort", "larerveiledning"],
  competencyGoals: [
    { no: "Eleven kan bruke ordklasser, synonymer og antonymer, bygge og utvide setninger, og lese og skrive med økende forståelse og struktur.", en: "" },
  ],
  contains: [
    { no: "Tolv aktiviteter: ordklasser, sammensatte ord, synonymer, antonymer, bygge setninger, rekkefølge, leseforståelse, lese mellom linjene, utvid setningen, planlegg en fortelling, les korrektur, og kreativ skriving", en: "" },
    { no: "Tolv språkkort (tre ark) til å velge og klippe ut", en: "" },
    { no: "\"Bygg en setning\"- og \"Min tekst\"-arbeidsark for planlegging og skriving", en: "" },
    { no: "Veiledning til den voksne om å koble muntlig språk, lesing, skriving og refleksjon", en: "" },
  ],
  pageCount: 20,
  language: ["nb"],
  fileFormat: ["pdf"],
  ...
  differentiation: {
    no: "For 6–9 år: koble muntlig språk, lesing, skriving og refleksjon. Tilpass tekstmengde og støtte til den enkeltes lese- og skriveutvikling.", en: "",
  },
  montessoriArea: {
    area: { no: "Språk: lesing, skriving og språklig bevissthet", en: "" },
    presentation: {
    ...
    prerequisites: { no: "Kan brukes alene eller som en videreføring av «Språklek 3–6 år».", en: "" },
    directPurpose: { no: "Utvide ordforråd og setningsbygning, og øve lesing og skriving med mening.", en: "" },
    indirectPurpose: { no: "Bygge språklig bevissthet, leseforståelse og skriveglede.", en: "" },
    controlOfError: { no: "Eleven kontrollerer egen tekst gjennom lesing, korrektur og sammenligning med språkmodellen.", en: "" },
    extension: { no: "La eleven skrive en lengre fortelling, eller lese korrektur på en medelevs tekst.", en: "" },
  },
  license: "privat",
  priceType: "betalt",
  price: { no: "99 kr", en: "" },
