...
function contentPrompt(b) {
  ...
  const shapes = {
    ...
    reel: `{"format":"reel","title":"kort arbeidstittel","hook":"tekst-på-skjerm 0-3s, maks 8 ord","voiceover":"hele voiceover-manuset","scenes":[{"time":"0-3s","onScreen":"tekst","voiceover":"det som sies","broll":"ALLTID PÅ ENGELSK: visuell prompt for en vertikal 9:16 scene, ingen tekst i bildet. Følg temaet/kilden. Handler scenen om et konkret Montessori-materiell, bruk LMEs rosa/krem Montessori-stil, navngi materiellet presist med det engelske navnet OG beskriv nøyaktig hvordan det ser ut (riktige farger, antall deler, form og oppsett), f.eks. 'the Pink Tower: ten graduated pink wooden cubes stacked from largest at the bottom to smallest at the top' eller 'the Golden Bead material: a unit bead, a ten-bar, a hundred-square and a thousand-cube in golden beads', aldri bare 'a wooden toy'. Handler scenen IKKE om Montessori, beskriv i stedet et realistisk bilde som faktisk passer temaet, ikke tving inn Montessori-materiell eller den rosa/krem paletten."}],"musicMood":"stil","caption":"caption","cta":"varm, tydelig oppfordring til handling","keywords":["6-10 søkeord folk kan søke etter"],"hashtags":["8-12 hashtags"]}`,
    ...
    post: `{"format":"post","title":"kort arbeidstittel","caption":"ferdig feed-caption, answer-first, varm CTA","hashtags":["8-12 hashtags"],"imagePrompt":"detaljert bilde-prompt som følger temaet/kilden. Handler temaet om Montessori, bruk LMEs rosa/krem Montessori-stil. Ellers, bruk et bilde som faktisk passer temaet."}`,
    ...
    hookreel: `{"format":"hookreel","title":"kort arbeidstittel","hook":"scroll-stoppende tekst-på-skjerm i de første sekundene, 4-10 ord, skaper nysgjerrighet","voiceover":"hele det personlige manuset i jeg-form, historie som drar leseren inn og gir ekte verdi","scenes":[{"time":"0-3s","onScreen":"tekst-hook","voiceover":"det som sies","broll":"ALLTID PÅ ENGELSK: visuell prompt for vertikal 9:16, enten meg som snakker til kamera eller rolig lifestyle b-roll, ingen tekst i bildet. Følg temaet/kilden. Vises et konkret Montessori-materiell, bruk LME-stilen, navngi det presist med det engelske navnet OG beskriv nøyaktig utseende (farger, antall deler, form, oppsett), f.eks. 'the Pink Tower: ten graduated pink wooden cubes from largest to smallest', aldri bare 'a wooden toy'. Handler scenen IKKE om Montessori, beskriv i stedet et realistisk bilde som faktisk passer temaet."}],"cta":"kommentar-basert oppfordring, f.eks. Kommenter ORDET nedenfor, så sender jeg deg …","caption":"ferdig caption","hashtags":["6-10 hashtags"]}`,
    explainer: `{"format":"explainer","title":"kort arbeidstittel","level":"hvem videoen passer for, ut fra temaet, f.eks. foreldre, barnehage 3-6 år, skole, eller andre skapere/gründere","hook":"åpningssetning som skrives på tavla, maks 8 ord","scenes":[{"time":"0-8s","board":"det som tegnes/skrives på whiteboarden i denne scenen, korte stikkord","narration":"det som fortelles med rolig stemme, 1-2 setninger","illustration":"ALLTID PÅ ENGELSK: ett konkret motiv som kan tegnes som én håndtegnet blyantskisse for denne scenen. Følg temaet/kilden. Handler scenen om et konkret Montessori-materiell, navngi det presist med det engelske navnet OG beskriv nøyaktig hvordan det faktisk ser ut, med riktige farger, antall deler, form og oppsett, f.eks. 'the Pink Tower: ten graduated pink wooden cubes stacked from largest at the bottom to smallest at the top'. Handler scenen IKKE om Montessori, tegn i stedet et motiv som faktisk illustrerer temaet, f.eks. 'a hand typing on a laptop with a YouTube upload icon on screen'. Ett tydelig motiv, ingen tekst i bildet."}],"takeaway":"én setning som oppsummerer det seeren skal huske","caption":"kort delings-caption for Instagram/TikTok","hashtags":["6-10 hashtags"]}`,
