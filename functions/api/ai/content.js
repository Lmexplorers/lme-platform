...
function contentPrompt(b) {
  ...
  const shapes = {
    ...
    reel: `{"format":"reel","title":"kort arbeidstittel","hook":"tekst-på-skjerm 0-3s, maks 8 ord","voiceover":"hele voiceover-manuset","scenes":[{"time":"0-3s","onScreen":"tekst","voiceover":"det som sies","broll":"ALLTID PÅ ENGELSK: visuell prompt for en vertikal 9:16 scene, ingen tekst i bildet. Beskriv et konkret, realistisk motiv som følger temaet/kilden eksakt. Vises mennesker, beskriver deres miljø og handling. Vises materialer eller objekter, beskriv dem nøyaktig (farger, form, størrelse, antall). Dikterer aldri opp Montessori-materiell eller lila/rosa/krem Montessori-tema med mindre kilden eksplisitt handler om Montessori."}],"musicMood":"stil","caption":"caption","cta":"varm, tydelig oppfordring til handling","keywords":["6-10 søkeord folk kan søke etter"],"hashtags":["5 relevante hashtags for TikTok (max 5)"]}`,
    ...
    post: `{"format":"post","title":"kort arbeidstittel","caption":"ferdig feed-caption, answer-first, varm CTA","hashtags":["8-12 hashtags"],"imagePrompt":"detaljert bilde-prompt som følger temaet/kilden eksakt. Beskriv et konkret, realistisk motiv som illustrerer innholdet. Vises mennesker, beskriv deres miljø og handling. Vises materialer eller objekter, beskriv dem nøyaktig (farger, form, størrelse, antall). Dikterer aldri opp Montessori-materiell eller Montessori-fargepalett med mindre kilden eksplisitt handler om Montessori."}`,
    ...
    pinterest: `{"format":"pinterest","pinTitle":"søkbar tittel maks 100 tegn","pinDescription":"150-200 tegn med nøkkelord og myk CTA","imagePrompt":"detaljert Canva/bilde-prompt som følger temaet/kilden eksakt. Beskriv et konkret, realistisk motiv som illustrerer innholdet. Vises mennesker, beskriv deres miljø og handling. Vises materialer eller objekter, beskriv dem nøyaktig (farger, form, størrelse). Dikterer aldri opp Montessori-materiell eller Montessori-stil med mindre kilden eksplisitt handler om Montessori."}`,
    hookreel: `{"format":"hookreel","title":"kort arbeidstittel","hook":"scroll-stoppende tekst-på-skjerm i de første sekundene, 4-10 ord, skaper nysgjerrighet","voiceover":"hele det personlige manuset i jeg-form, historie som drar leseren inn og gir ekte verdi","scenes":[{"time":"0-3s","onScreen":"tekst-hook","voiceover":"det som sies","broll":"ALLTID PÅ ENGELSK: visuell prompt for vertikal 9:16, enten meg som snakker til kamera eller rolig lifestyle b-roll, ingen tekst i bildet. Beskriv et konkret, realistisk motiv som følger temaet/kilden eksakt. Vises mennesker, beskriv deres miljø og handling. Vises materialer eller objekter, beskriv dem nøyaktig (farger, form, størrelse, antall). Dikterer aldri opp Montessori-materiell eller Montessori-stil med mindre kilden eksplisitt handler om Montessori."}],"cta":"kommentar-basert oppfordring, f.eks. Kommenter ORDET nedenfor, så sender jeg deg …","caption":"ferdig caption","hashtags":["5 relevante hashtags for TikTok (max 5)"]}`,
    explainer: `{"format":"explainer","title":"kort arbeidstittel","level":"hvem videoen passer for, ut fra temaet, f.eks. foreldre, barnehage 3-6 år, skole, eller andre skapere/gründere","hook":"åpningssetning som skrives på tavla, maks 8 ord","scenes":[{"time":"0-8s","board":"det som tegnes/skrives på whiteboarden i denne scenen, korte stikkord","narration":"det som fortelles med rolig stemme, 1-2 setninger","illustration":"ALLTID PÅ ENGELSK: ett konkret motiv som kan tegnes som én håndtegnet blyantskisse for denne scenen. Beskriv et motiv som følger temaet/kilden eksakt. Vises mennesker, beskriv deres handling. Vises objekter eller konkrete ting, beskriv dem nøyaktig (form, farger, størrelse). Dikterer aldri opp Montessori-materiell eller rosa/krem Montessori-stil med mindre kilden eksplisitt handler om Montessori. Ett tydelig motiv, ingen tekst i bildet."}],"takeaway":"én setning som oppsummerer det seeren skal huske","caption":"kort delings-caption for Instagram/TikTok","hashtags":["6-10 hashtags"]}`,
