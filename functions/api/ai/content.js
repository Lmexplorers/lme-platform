...
Sørg for at hvert element er fysisk realistisk og bildet kunne eksistere som et ekte fotografi.`;
  ...
  const shapes = isEnglish ? {
    carousel: `{"format":"carousel","title":"short working title","slides":[{"text":"slide 1 text: compelling hook or introduction to grab attention","imagePrompt":"ALWAYS IN ENGLISH: specific, realistic visual prompt for horizontal image (3:2 ratio) illustrating this exact slide text"},{"text":"slide 2 text: second key point building on slide 1","imagePrompt":"ALWAYS IN ENGLISH: specific, realistic visual prompt for horizontal image (3:2 ratio) illustrating this exact slide text"},{"text":"slide 3 text: continue the story or expand value proposition","imagePrompt":"ALWAYS IN ENGLISH: specific, realistic visual prompt for horizontal image (3:2 ratio) illustrating this exact slide text"},{"text":"slide 4 text: additional details, benefits or supporting point","imagePrompt":"ALWAYS IN ENGLISH: specific, realistic visual prompt for horizontal image (3:2 ratio) illustrating this exact slide text"},{"text":"slide 5 text: deeper insight or practical example","imagePrompt":"ALWAYS IN ENGLISH: specific, realistic visual prompt for horizontal image (3:2 ratio) illustrating this exact slide text"},{"text":"slide 6 text: another perspective or result","imagePrompt":"ALWAYS IN ENGLISH: specific, realistic visual prompt for horizontal image (3:2 ratio) illustrating this exact slide text"},{"text":"slide 7 text: more value or common question addressed","imagePrompt":"ALWAYS IN ENGLISH: specific, realistic visual prompt for horizontal image (3:2 ratio) illustrating this exact slide text"},{"text":"slide 8 text: call to action or closing message","imagePrompt":"ALWAYS IN ENGLISH: specific, realistic visual prompt for horizontal image (3:2 ratio) illustrating this exact slide text"}],"caption":"finished caption","hashtags":["8-12 hashtags"]}`,
    reel: `{"format":"reel","title":"short working title","hook":"on-screen text 0-3s, max 8 words","voiceover":"full voiceover script","scenes":[{"time":"0-3s","onScreen":"text","voiceover":"what is said","broll":"ALWAYS IN ENGLISH: visual prompt for a vertical 9:16 scene, no text in the image. Generate a specific, realistic, well-composed photograph that illustrates the theme."}],"musicMood":"style","caption":"caption","cta":"warm, clear call to action","keywords":["6-10 search terms people can search for"],"hashtags":["5 relevant hashtags for TikTok (max 5)"],"ads":"true"}`,
    ...
    carousel: `{"format":"carousel","title":"kort arbeidstittel","slides":[{"text":"slide 1 tekst: sterk hook eller introduksjon for å fange oppmerksomhet","imagePrompt":"ALLTID PÅ ENGELSK: spesifikk, realistisk visuell prompt for horisontalt bilde (3:2 ratio) som illustrerer denne eksakte slide-teksten"},{"text":"slide 2 tekst: andre viktige poeng som bygger på slide 1","imagePrompt":"ALLTID PÅ ENGELSK: spesifikk, realistisk visuell prompt for horisontalt bilde (3:2 ratio) som illustrerer denne eksakte slide-teksten"},{"text":"slide 3 tekst: fortsett historien eller utvid verdipropositionen","imagePrompt":"ALLTID PÅ ENGELSK: spesifikk, realistisk visuell prompt for horisontalt bilde (3:2 ratio) som illustrerer denne eksakte slide-teksten"},{"text":"slide 4 tekst: flere detaljer, fordeler eller støttepunkt","imagePrompt":"ALLTID PÅ ENGELSK: spesifikk, realistisk visuell prompt for horisontalt bilde (3:2 ratio) som illustrerer denne eksakte slide-teksten"},{"text":"slide 5 tekst: dypere innsikt eller praktisk eksempel","imagePrompt":"ALLTID PÅ ENGELSK: spesifikk, realistisk visuell prompt for horisontalt bilde (3:2 ratio) som illustrerer denne eksakte slide-teksten"},{"text":"slide 6 tekst: annet perspektiv eller resultat","imagePrompt":"ALLTID PÅ ENGELSK: spesifikk, realistisk visuell prompt for horisontalt bilde (3:2 ratio) som illustrerer denne eksakte slide-teksten"},{"text":"slide 7 tekst: mer verdi eller vanlig spørsmål besvart","imagePrompt":"ALLTID PÅ ENGELSK: spesifikk, realistisk visuell prompt for horisontalt bilde (3:2 ratio) som illustrerer denne eksakte slide-teksten"},{"text":"slide 8 tekst: oppfordring til handling eller avsluttende melding","imagePrompt":"ALLTID PÅ ENGELSK: spesifikk, realistisk visuell prompt for horisontalt bilde (3:2 ratio) som illustrerer denne eksakte slide-teksten"}],"caption":"ferdig caption","hashtags":["8-12 hashtags"]}`,
    reel: `{"format":"reel","title":"kort arbeidstittel","hook":"tekst-på-skjerm 0-3s, maks 8 ord","voiceover":"hele voiceover-manuset","scenes":[{"time":"0-3s","onScreen":"tekst","voiceover":"det som sies","broll":"ALLTID PÅ ENGELSK: visuell prompt for en vertikal 9:16 scene, ingen tekst i bildet. Generer et spesifikt, realistisk, godt komponert fotografi som illustrerer temaet."}],"musicMood":"stil","caption":"caption","cta":"varm, tydelig oppfordring til handling","keywords":["6-10 søkeord folk kan søke etter"],"hashtags":["5 relevante hashtags for TikTok (max 5)"],"ads":"true"}`,
...
export async function onRequestPost(context) {
  ...
  try {
    ...
    // Midlertidig: ta med faktisk årsak og hvilke nøkler som finnes for feilsøking.
    const keys = "A:" + (env.ANTHROPIC_API_KEY ? "1" : "0") + " O:" + (env.OPENAI_API_KEY ? "1" : "0");
    return json({ error: "AI utilgjengelig [" + keys + "] " + String((err && err.message) || err).slice(0, 200) }, 502);
  }
}
