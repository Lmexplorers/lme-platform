...
Sørg for at hvert element er fysisk realistisk og bildet kunne eksistere som et ekte fotografi.`;
  ...
  const shapes = isEnglish ? {
    carousel: `{"format":"carousel","title":"short working title","slides":[{"text":"slide 1 text: compelling hook or introduction","imagePrompt":"ALWAYS IN ENGLISH: specific, realistic visual prompt for horizontal image (3:2 ratio) illustrating this exact slide text"},{"text":"slide 2 text: next key point building on slide 1","imagePrompt":"ALWAYS IN ENGLISH: specific, realistic visual prompt for horizontal image (3:2 ratio) illustrating this exact slide text"},{"text":"slide 3 text: continue the story or value prop","imagePrompt":"ALWAYS IN ENGLISH: specific, realistic visual prompt for horizontal image (3:2 ratio) illustrating this exact slide text"},{"text":"slide 4+ text: more details or benefits","imagePrompt":"ALWAYS IN ENGLISH: specific, realistic visual prompt for horizontal image (3:2 ratio) illustrating this exact slide text"}],"caption":"finished caption","hashtags":["8-12 hashtags"]}`,
    ...
    carousel: `{"format":"carousel","title":"kort arbeidstittel","slides":[{"text":"slide 1 tekst: sterk hook eller introduksjon","imagePrompt":"ALLTID PÅ ENGELSK: spesifikk, realistisk visuell prompt for horisontalt bilde (3:2 ratio) som illustrerer denne eksakte slide-teksten"},{"text":"slide 2 tekst: neste viktige poeng som bygger på slide 1","imagePrompt":"ALLTID PÅ ENGELSK: spesifikk, realistisk visuell prompt for horisontalt bilde (3:2 ratio) som illustrerer denne eksakte slide-teksten"},{"text":"slide 3 tekst: fortsett historien eller verdipropositionen","imagePrompt":"ALLTID PÅ ENGELSK: spesifikk, realistisk visuell prompt for horisontalt bilde (3:2 ratio) som illustrerer denne eksakte slide-teksten"},{"text":"slide 4+ tekst: mer detaljer eller fordeler","imagePrompt":"ALLTID PÅ ENGELSK: spesifikk, realistisk visuell prompt for horisontalt bilde (3:2 ratio) som illustrerer denne eksakte slide-teksten"}],"caption":"ferdig caption","hashtags":["8-12 hashtags"]}`,
