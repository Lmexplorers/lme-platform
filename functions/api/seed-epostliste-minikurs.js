/**
 * Engangs-import: laster det nye gratis Kursbygger-kurset "Få dine første
 * 100 e-postabonnenter" (skrevet i koden, se
 * _lib/seed-epostliste-minikurs-data.js) rett inn i Kursbygger sin lagring
 * (KV), uten at Renate må lime det inn manuelt i Kursbygger-UI-et. Samme
 * mønster som seed-montessori-kurs.js.
 *
 * GET /api/seed-epostliste-minikurs?pw=<COURSE_EDIT_PASSWORD>
