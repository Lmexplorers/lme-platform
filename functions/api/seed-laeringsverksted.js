...
export async function onRequestGet(context) {
  ...
  const results = [];
  for (const raw of [LIVETS_TIDSLINJE, PLANSJER_OG_KORTSETT, DE_SMA_NATURUTFORSKERNE, SKOLEDAGBOK_1_3_TRINN, SKOLEDAGBOK_4_7_TRINN, MIA_TEO_FOLELSER, MIA_TEO_SITUASJONSKORT, MIA_TEO_SNAKKE_OM_FOLELSER, MIA_TEO_KROPP_3_6, MIA_TEO_KROPP_6_9]) {
