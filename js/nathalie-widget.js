/* =========================================================
   ...
   <script src="/js/nathalie-widget.js" defer></script>
   ...
   ========================================================= */
/* HVORFOR FILEN BYTTET NAVN 1. september 2026
   Knappen sto lenge og sa "Spør Renate AI" på Renates egen maskin, lenge
   etter at teksten var endret til Nathalie AI overalt. Grunnen var ikke
   teksten, men adressen: alle 213 sidene hentet denne filen som
   renate-widget.js?v=5, og da teksten ble endret ble ikke tallet bak v=
   økt. Nettleseren så samme adresse som før, og spilte av sin egen lagrede
   kopi fra før navnebyttet. En slik kopi kan bli liggende i ukevis.
   Ny adresse tvinger fram en fersk henting hos alle, og no-store i _headers
   gjør at det ikke kan skje igjen. */
(function () {
  'use strict';
  ...
  root.innerHTML =
    ...
    '  <div class="rw-head">' +
    '    <div class="rw-avatar">N<img src="/images/nathalie-portrait.jpg?v=3" alt="" onerror="this.remove()"></div>' +
    '    <div>' +
    '      <h4>Nathalie AI</h4>' +
    ...
    '  <span class="rw-btn-avatar">N<img src="/images/nathalie-portrait.jpg?v=3" alt="" onerror="this.remove()"></span>' +
