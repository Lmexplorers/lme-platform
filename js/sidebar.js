...
(function () {
  var SIDEBAR_HTML = [
    ...
    '  <span class="sidebar-item disabled"><span class="si-icon">📧</span><span class="si-label">Email</span><span class="si-badge">Snart</span></span>',
    '  <span class="sidebar-item disabled"><span class="si-icon">⚡</span><span class="si-label">Automations</span><span class="si-badge">Snart</span></span>',
    '</div>',
    '<div class="sidebar-group">',
