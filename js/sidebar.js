...
(function () {
  var SIDEBAR_HTML = [
    ...
    '  <a href="https://lme-contentstudio.pages.dev" target="_blank" rel="noopener" class="sidebar-item"><span class="si-icon">🎨</span><span class="si-label">LME Content Studio</span></a>',
