...
(function () {
  var SIDEBAR_HTML = [
    ...
    '  <a href="/apper" class="sidebar-item"><span class="si-icon">🧰</span><span class="si-label" data-no="Apper" data-en="Apps">Apper</span></a>',
    '  <a href="/oppgrader" class="sidebar-item"><span class="si-icon">💛</span><span class="si-label" data-no="Priser og planer" data-en="Prices and plans">Priser og planer</span></a>',
    '</div>',
    '<div class="sidebar-group">',
    ...
    '  <div class="ai-avatar" style="position:relative;overflow:hidden">N<img src="/images/nathalie-portrait.jpg?v=3" alt="" style="width:100%;height:100%;object-fit:cover;border-radius:50%;position:absolute;inset:0" onerror="this.remove()"></div>',
