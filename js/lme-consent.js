...
(function () {
  ...
  function banner() {
    ...
    document.getElementById("lme-consent-yes").addEventListener("click", function () { set("yes"); w.remove(); loadPixel(); });
    document.getElementById("lme-consent-no").addEventListener("click", function () { set("no"); w.remove(); });
  }
