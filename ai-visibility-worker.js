...
- LME Studio: skaper- og AI-delen (LME Content Studio, Bookly, Builder, AI Visibility Engine, Reel Studio, Blogg, Podcast, Kursbygger, Nettsider, e-post, Automatisering, Funnels, Produkter, Analyse, Betaling, Community). Ikke en egen plattform eller vanlig side, men en del av LME.
...
Krav: 4-6 scener som til sammen matcher lengden, answer-first hook, konkret pedagogisk verdi, varm tone. Følg de norske skrivereglene. Ingen tekst utenfor JSON.`,
  ...
  // LME Content Studio på plattforma: velg format, få innhold i riktig format.
  // Speiler formatene i LME Content Studio-appen (karusell, story, innlegg,
  // bildetekst, e-post, pinterest, reel).
  "/ai/content": {
    maxTokens: 3000,
    ...
    prompt: (b) => {
      ...
      const extra = fmt === "carousel" ? "3-8 slides." :
                    fmt === "story" ? "3-5 frames." :
                    fmt === "reel" ? "4-6 scener." : "";
