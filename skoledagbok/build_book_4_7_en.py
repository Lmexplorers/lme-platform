#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Mia & Teo School Diary Grades 4-7 - FULL book, print-ready A5 portrait, school year 2026/2027."""
import os
import datetime
...
OUT = os.environ.get("DIARY_OUT", os.path.join(_BASE, "Mia-and-Teo-school-diary-2026-2027-A5-grades-4-7.pdf"))
...
UNDRING=[
 "What did you work on today that you would like to explore more?",
 "Was there something today you disagreed with? What did you think yourself?",
 "If you could ask the teacher one more question, what would it be?",
 "What are you curious about right now, completely outside school?",
 "How do you think something you used today was made?",
 "What would you research if you were a scientist for a day?",
 "What is the difference between knowing something and understanding it, do you think?",
 "Which invention do you wish existed?",
 "What makes something fair or unfair, do you think?",
 "If you could travel anywhere to learn something, where?",
 "What do you think people will wonder about in a hundred years?",
 ...
 "What do you think happens in the brain when you learn something new?",
 "Which animal do you think is the cleverest, and why?",
 "What would you do if a day lasted 30 hours?",
 "What is the hardest thing you have managed all by yourself?",
 "Why do you think some things get easier when you practise?",
 "What is a good friend, really?",
 "If your thoughts had a colour today, which one?",
 "What do you think is out at the far edge of space?",
 "Which book or film made you think in a new way?",
 "What would you change about school if you got to decide?",
 "How do we know that something is true?",
 "What is something grown-ups do not quite understand, do you think?",
 "If you could master one thing perfectly, what would it be?",
 "What calms you down when a lot is going on around you?",
 "Why do you think some numbers, like zero, are so special?",
 "What do you think happens to an idea after you have had it?",
 "Which question do you wish you knew the answer to?",
 "What does it mean to be brave, do you think?",
 "How would you explain colours to someone who has never seen?",
 "What is the nicest thing someone has done for you?",
 "Which rule do you think is wise, and which is strange?",
 "What do you think makes people become good friends?",
 "If you could teach one thing to someone younger, what?",
 "What is something you believed before, but do not believe anymore?",
 "Why do you think time feels faster sometimes?",
 "What would you make if you had everything you needed?",
 "What is the most important thing a person can know, do you think?",
 "Which little thing made your day better today?",
 "What do you think plants would say if they could talk?",
 "What do you think is the difference between smart and wise?",
 "If you got an hour all to yourself, what would you do?",
 "What do you think you will remember from today in ten years?",
]
WUNDRING=[
...
def moodrow_voksen():
    # 1-5 rating like at secondary school: the child circles the number
    ...
    return f'<div class="moodrow voksen"><span class="mlabel">Today\'s rating</span><div class="mgroup"><span class="mhint">1 = tough day</span><div class="mscale">{dots}</div><span class="mhint">5 = great</span></div></div>'
...
def cover():
    return f'''<div class="page cover">
      ...
      <div class="cgrade">Grades 4-7</div>
      <div class="cage">(ages 9-13)</div>
...
def school_day(d,uke,uidx):
    # Mondays get a thin weekly-goal strip (not a whole card), and fewer school lines
    er_mandag = d.weekday()==0
    ukesmaal=""
    if er_mandag:
        ukesmaal='<div class="maalstripe"><span class="ml">This week I want to</span><span class="rline"></span></div>'
    skolelinjer = 4 if er_mandag else 6
    return f'''<div class="page">
      {band(EN_DAYS[d.weekday()], f"WEEK {uke} &nbsp;·&nbsp; {datestr(d)}")}
      {moodrow_voksen()}
      {ukesmaal}
      <div class="card school"><div class="flabel">At school today</div>{lines(skolelinjer)}</div>
      <div class="card reflect">
        <div class="rrow"><div class="flabel">Something I worked on or explored</div><span class="rline"></span></div>
        <div class="rrow"><div class="flabel">Something I want to work on at home</div><span class="rline"></span></div>
        <div class="rrow"><div class="flabel">Something I am pleased with today</div><span class="rline"></span></div>
      </div>
      <div class="undring"><div class="txt"><div class="ut">Today's wondering</div><div class="q">{UNDRING[uidx%len(UNDRING)]}</div></div><img src="file://{A}/mia-og-teo-eldre.png"></div>
    </div>'''
...
def weekend_day(d,uke,widx):
    return f'''<div class="page">
      ...
      <div class="undring"><div class="txt"><div class="ut">Today's wondering</div><div class="q">{WUNDRING[widx%len(WUNDRING)]}</div></div><img src="file://{A}/mia-og-teo-eldre.png"></div>
    </div>'''

FERIE_UNDRING=["What are you looking forward to most in the holiday?","What do you think is the nicest thing about winter?",
 "Who do you want to do something extra kind for in the holiday?","What is the best holiday day you have had?",
 "What are you most grateful for right now?","If you could decide a whole holiday day, what would you do?",
 "What do you like to do when it is cold and dark outside?","What do you think the animals do in winter?"]
FERIE_AKTIVITET=[
 ("Something nice I did today","Draw or write about a good moment"),
 ("Something I made or baked","Maybe something tasty in the kitchen?"),
 ("Someone I spent time with","What did you get up to together?"),
 ("Something I saw outside in the winter cold","Snow, frost, tracks or stars?"),
 ("Something I enjoyed indoors","A book, a film or a game?"),
 ("A good deed I did","Something kind for someone else"),
]
def ferie_day(d,uke,navn,fidx):
    ...
    return f'''<div class="page">
      ...
      <div class="undring"><div class="txt"><div class="ut">Holiday wondering</div><div class="q">{FERIE_UNDRING[fidx%len(FERIE_UNDRING)]}</div></div><img src="file://{A}/mia-og-teo-eldre.png"></div>
    </div>'''
...
def p_utebingo(s):
    ...
    return f'''<div class="page">
      ...
      <div class="undring tip"><div class="txt"><div class="ut">A little tip</div><div class="q">You do not need to find everything at once. Nature is there every day, waiting for you.</div></div><img src="file://{A}/mia-og-teo-eldre.png"></div>
    </div>'''
...
def p_forsker(s):
    ...
    return f'''<div class="page">
      ...
      <div class="undring tip"><div class="txt"><div class="ut">Did you know</div><div class="q">A tiny seed has everything it needs inside it to become a plant. It is just waiting for soil, water and light.</div></div><img src="file://{A}/mia-og-teo-eldre.png"></div>
    </div>'''
...
def p_takk(s):
    return f'''<div class="page">
      ...
      <div class="undring"><div class="txt"><div class="ut">Mia &amp; Teo say</div><div class="q">Small good things count too. A good hug, sun on your face, or something tasty to eat.</div></div><img src="file://{A}/mia-og-teo-eldre.png"></div>
    </div>'''
...
def p_telle(s, tip=0):
    ...
    return f'''<div class="page">
      ...
      <div class="undring tip"><div class="txt"><div class="ut">Did you know</div><div class="q">{TELLE_TIPS[tip%len(TELLE_TIPS)]}</div></div><img src="file://{A}/mia-og-teo-eldre.png"></div>
    </div>'''
...
def p_stille(s):
    return f'''<div class="page">
      ...
      <div class="undring tip"><div class="txt"><div class="ut">A little tip</div><div class="q">It is good for the brain to rest a little. You do not need to do anything, just be.</div></div><img src="file://{A}/mia-og-teo-eldre.png"></div>
    </div>'''
...
LESETIPS=[
 "Try a book about something you are curious about. Non-fiction counts just as much as stories.",
 "Comics are real reading. They are a great way to get started.",
 "Read a few pages aloud to someone at home, or let them read to you.",
 "Not enjoying the book after a while? It is completely fine to switch to another one.",
 "Bring a book outside. A tree or a bench can become the nicest reading spot.",
 "Ask a friend what they are reading. The best tips often come from each other.",
 "Read the same book as a friend, so you can talk about it afterwards.",
 "Flip through a wordless book too. You can make up the story yourself.",
 "Listen to an audiobook while you draw. That is experiencing a story too.",
 "Set yourself a small reading goal this month, and see how it goes.",
]
def p_leselogg(s, idx=0):
    ...
    return f'''<div class="page">
      {band("My reading log","Books I have read this month")}
      <div class="card"><div class="flabel">Books I have read</div><div class="hint">Write the titles of the books you have read, or been read to.</div>{rows}</div>
      <div class="card reflect tight">
        <div class="rrow"><div class="flabel">A book I really liked, and why</div><span class="rline"></span></div>
        <div class="rrow"><div class="flabel">A book I would recommend to a friend</div><span class="rline"></span></div>
      </div>
      <div class="undring tip"><div class="txt"><div class="ut">Book tip</div><div class="q">{tip}</div></div><img src="file://{A}/mia-og-teo-eldre.png"></div>
    </div>'''
...
while d<=END:
    ...
    if d.weekday()==6:   # after Sunday: one activity page
        ...
        if ts!=prev_season:
            ...
            # fixed monthly reading log + book tip (as in a normal school diary)
...
open(os.path.join(_BASE, "book_4_7_en.html"),"w").write(DOC)
